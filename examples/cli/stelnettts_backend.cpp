// stelnettts_backend.cpp — backend factory, auto-detection, and helpers.
...
// its own stelnettts_backend_X.cpp file and compiled only if the backend's
...
std::unique_ptr<StelnetAsrBackend> stelnettts_make_canary_backend();
...
std::unique_ptr<StelnetAsrBackend> stelnettts_make_orpheus_backend();
...
std::unique_ptr<StelnetAsrBackend> stelnettts_make_moss_tts_backend();
...
#ifdef STELNETTTS_HAVE_OUTETTS
std::unique_ptr<StelnetAsrBackend> stelnettts_make_outetts_backend();
#endif
std::unique_ptr<StelnetAsrBackend> stelnettts_make_zonos_backend();
...
std::unique_ptr<StelnetAsrBackend> stelnettts_make_dots_tts_backend();
...
std::unique_ptr<StelnetAsrBackend> stelnettts_create_backend(const std::string& name) {
    ...
    if (name == "whisper" || name == "tiron")
        return stelnettts_make_whisper_backend();
    if (name == "gigaam" || name == "gigaam-v3" || name == "gigaam3")
        return stelnettts_make_gigaam_backend();
    if (name == "nemotron" || name == "nemotron-streaming" || name == "nemotron-3.5" || name == "nemotron-asr" ||
        name == "nemotron-speech-streaming")
        return stelnettts_make_nemotron_backend();
    if (name == "parakeet" || name == "reazonspeech")
        return stelnettts_make_parakeet_backend();
    if (name == "canary")
        return stelnettts_make_canary_backend();
    if (name == "canary-qwen" || name == "canary_qwen" || name == "canary-qwen-2.5b")
        return stelnettts_make_canary_qwen_backend();
    if (name == "lfm2-audio")
        return stelnettts_make_lfm2_audio_backend();
    if (name == "mini-omni2" || name == "mini_omni2" || name == "miniomni2")
        return stelnettts_make_mini_omni2_backend();
    if (name == "cohere" || name == "cohere-ar")
        return stelnettts_make_cohere_backend();
    if (name == "granite" || name == "granite-4.1" || name == "granite-4.1-plus")
        return stelnettts_make_granite_backend();
    if (name == "granite-4.1-nar" || name == "granite-nar")
        return stelnettts_make_granite_nle_backend();
    if (name == "voxtral")
        return stelnettts_make_voxtral_backend();
    if (name == "voxtral4b")
        return stelnettts_make_voxtral4b_backend();
    if (name == "voxtral-tts")
        return stelnettts_make_voxtral_tts_backend();
    if (name == "higgs-stt" || name == "higgs_stt" || name == "higgs-audio-v3-stt" || name == "higgs-audio-stt" ||
        name == "higgsaudiostt")
        return stelnettts_make_higgs_stt_backend();
    if (name == "qwen3" || name == "qwen3-1.7b" || name == "qwen3_1.7b" || name == "qwen3_17b" || name == "mega-asr" ||
        name == "mega_asr" || name == "megaasr")
        return stelnettts_make_qwen3_backend();
    if (name == "fastconformer-ctc" || name == "fastconformer_ctc" || name == "canary-ctc" || name == "canary_ctc")
        return stelnettts_make_fastconformer_ctc_backend();
    if (name == "wav2vec2" || name == "hubert" || name == "data2vec")
        return stelnettts_make_wav2vec2_backend();
    if (name == "vibevoice" || name == "vibevoice-bitnet" || name == "vibevoice-asr-bitnet")
        return stelnettts_make_vibevoice_backend();
    if (name == "vibevoice-tts")
        return stelnettts_make_vibevoice_tts_backend();
    if (name == "kugelaudio" || name == "kugelaudio-tts" || name == "kugelaudio-0-open")
        return stelnettts_make_kugelaudio_backend();
    if (name == "vibevoice-1.5b" || name == "vibevoice-tts-1.5b" || name == "vibevoice-tts-base")
        return stelnettts_make_vibevoice_1p5b_backend();
    if (name == "cielvox2-tts" || name == "cielvox2_tts" || name == "cielvox2tts" || name == "cielvox2-tts-1.7b-base" ||
        name == "cielvox2-tts-1.7b")
        return stelnettts_make_cielvox2_tts_base_backend();
    if (name == "cielvox2-tts-customvoice" || name == "cielvox2tts-customvoice" || name == "cielvox2-tts-cv" ||
        name == "cielvox2-tts-1.7b-customvoice" || name == "cielvox2-tts-1.7b-cv" || name == "cielvox2-tts-1.7b-voicedesign" ||
        name == "cielvox2-tts-voicedesign" || name == "cielvox2-tts-vd")
        return stelnettts_make_cielvox2_tts_backend();
    if (name == "miotts" || name == "mio-tts" || name == "mio_tts" || name == "miotts-0.6b")
        return stelnettts_create_miotts_backend();
    if (name == "piano-transcription" || name == "piano_transcription" || name == "piano-trans")
        return stelnettts_create_piano_transcription_backend();
    if (name == "moss-tts-local" || name == "moss_tts_local" || name == "moss-tts-local-v1.5" ||
        name == "mosstts-local" || name == "moss-tts-local-transformer")
        return stelnettts_make_moss_tts_local_backend();
    if (name == "moss-tts" || name == "moss_tts" || name == "mosstts" || name == "moss-tts-v1.5" ||
        name == "moss-tts-delay")
        return stelnettts_make_moss_tts_backend();
    if (name == "orpheus" || name == "orpheus-tts" || name == "orpheus3b" || name == "kartoffel-orpheus" ||
        ...
        return stelnettts_make_orpheus_backend();
...
void stelnettts_print_backend_matrix() {
    const auto backends = stelnettts_list_backends();
    ...
    for (const auto& name : backends) {
        uint32_t caps = 0;
        auto be = stelnettts_create_backend(name);
        if (be)
...
void stelnettts_print_backend_matrix_json() {
    const auto backends = stelnettts_list_backends();
...
// filename heuristics.
std::string stelnettts_detect_backend_from_gguf(const std::string& model_path) {
    if (model_path.empty())
        return "";
    ...
    // `stelnettts_detect_backend_from_gguf` (src/core/arch_backend_map.h). Issue
...
bool stelnettts_gguf_is_pure_ctc(const std::string& model_path) {
