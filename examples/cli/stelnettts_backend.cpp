...
std::unique_ptr<CrispasrBackend> stelnettts_make_canary_backend();
...
std::unique_ptr<CrispasrBackend> stelnettts_make_orpheus_backend();
...
std::unique_ptr<CrispasrBackend> stelnettts_make_moss_tts_backend();
...
#endif
std::unique_ptr<CrispasrBackend> stelnettts_make_zonos_backend();
...
std::unique_ptr<CrispasrBackend> stelnettts_make_dots_tts_backend();
