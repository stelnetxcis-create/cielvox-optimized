// stelnettts_backend_granite_nle.cpp — granite-speech-4.1-2b-nar backend adapter.
//
// Mirrors the structure of stelnettts_backend_gemma4_e2b.cpp (simple end-to-end
// transcribe call) rather than stelnettts_backend_granite.cpp (which builds the
...
public:
    ...
    bool init(const whisper_params& params) override {
        ...
        if (getenv("STELNETTTS_VERBOSE") || stelnettts_env::get("STELNETTTS_GRANITE_NLE_BENCH"))
            cp.verbosity = 2;
