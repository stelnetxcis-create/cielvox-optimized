// stelnettts_marking_policy.h — who may opt out of the spoken AI-disclaimer.
//
...
// `needs_spoken_disclaimer` is stelnettts_voice::requires_spoken_disclosure(),
...
// that made it (see stelnettts_speaker_identity.h).
//
...
//
// The CLI enforces that per process (stelnettts_enforce_cli_watermark_floor(),
...
struct ContainerMarking {
    ...
    // MIME to hand stelnettts_c2pa_sign_auto(); empty when carries_c2pa is false.
...
// `is_clone`                — stelnettts_voice::classify_voice(...).is_clone.
...
//                             have.
// `needs_spoken_disclaimer` — stelnettts_voice::requires_spoken_disclosure(), i.e.
...
// bug. See stelnettts_speaker_identity.h.
