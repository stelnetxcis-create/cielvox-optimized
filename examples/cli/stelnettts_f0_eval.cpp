// stelnettts-f0-eval — measure and compare StelnetTTS's F0 backends.
//
//   stelnettts-f0-eval --crepe crepe-tiny-f16.gguf --beatrice beatrice-pitch-f32.gguf
//   stelnettts-f0-eval --beatrice <gguf> --wav samples/jfk.wav
//
...
int main(int argc, char** argv) {
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (a == "--crepe")
            ...
            fprintf(stderr, "usage: stelnettts-f0-eval [--crepe m.gguf] [--beatrice m.gguf] [--wav f.wav]\n");
            return 2;
        }
    }
