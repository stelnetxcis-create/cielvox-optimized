// stelnettts_backend_mel_band_roformer.cpp — Mel-Band RoFormer separation shim.
//
// Companion to stelnettts_backend_htdemucs.cpp: source separation is its own task
...
public:
    ...
    bool init(const whisper_params&) override {
        fprintf(stderr, "stelnettts: mel-band-roformer is a source-separation model — run it with --separate\n"
                        "  (e.g. `stelnettts --separate -m <mel-band-roformer-vocals-f16.gguf> -f song.wav`),\n"
