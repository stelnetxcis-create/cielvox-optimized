// stelnettts_punctuation_policy.h — decide when to auto-enable FireRedPunc.
...
inline bool stelnettts_should_auto_enable_punctuation(uint32_t caps, const whisper_params& params) {
