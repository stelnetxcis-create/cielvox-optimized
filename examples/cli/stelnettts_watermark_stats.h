// stelnettts_watermark_stats.h — how to read a spread-spectrum watermark score.
//
// The detector (stelnettts_watermark.h) is a SIGN-AGREEMENT TEST: it checks
...
//     AudioSeal score. stelnettts_wm_dispatch::get_ctx() says which detector ran.
...
//     Callers pass STELNETTTS_WATERMARK_NBINS; if fewer bins were actually
...
// ── Per-frame statistic (stelnettts_watermark_detect_frames_impl) ────────────
//
