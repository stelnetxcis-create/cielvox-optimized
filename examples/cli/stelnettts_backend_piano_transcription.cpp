// stelnettts_backend_piano_transcription.cpp — CLI adapter for piano transcription.
...
public:
    ...
    std::vector<stelnettts_segment> transcribe(const float* pcm, int n_samples, int64_t /*t0_ms*/,
