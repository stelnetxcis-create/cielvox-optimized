// stelnettts_stream_partial_decode.h — partial-decode cadence policy for
...
//                                              interval.
//
// Extracted from `stelnettts_run.cpp` so the policy is testable without
...
inline int64_t stelnettts_stream_partial_decode_interval_samples(int ms, int step_ms, int sample_rate) {
    if (sample_rate <= 0)
        return 0;
...
inline bool stelnettts_stream_partial_decode_allow(bool stream_json, int64_t last_partial_decode_sample,
