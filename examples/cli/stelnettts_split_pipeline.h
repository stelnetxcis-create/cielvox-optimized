// stelnettts_split_pipeline.h — when may the dispatcher overlap encode and decode?
//
...
// of them in the STELNETTTS_SLICE_PIPELINE override, and missed the per-slice
// post-pass entirely — which is a crash, not a degradation. Reproduced on
// parakeet-tdt-0.6b-v3 with STELNETTTS_PARAKEET_VAD_SLICE_CAP=12:
//
...
// `env` is the raw STELNETTTS_SLICE_PIPELINE value (nullptr when unset).
