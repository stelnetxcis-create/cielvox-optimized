// stelnettts_chunk_context_gate.h — gate for overlap-save context extension.
//
// Extracted from stelnettts_run.cpp into a header so unit tests can exercise
...
namespace stelnettts_chunk_context {
