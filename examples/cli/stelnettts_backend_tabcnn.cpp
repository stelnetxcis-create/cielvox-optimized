...
public:
    ...
    bool init(const whisper_params&) override {
        fprintf(stderr, "stelnettts: tabcnn is a guitar-tablature model — run it with --tab\n"
                        "  (e.g. `stelnettts --tab -m <tabcnn-f16.gguf> -f guitar.wav`), not as a\n"
