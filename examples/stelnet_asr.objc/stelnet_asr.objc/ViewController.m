...
#import <stelnet_asr/stelnet_asr.h>
...
{
    format->mSampleRate       = STELNET_ASR_SAMPLE_RATE;
...
- (IBAction)onTranscribe:(id)sender {
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        // run the model
        struct whisper_full_params params = whisper_full_default_params(STELNET_ASR_SAMPLING_GREEDY);
