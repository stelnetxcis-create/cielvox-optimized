...
//         in cielvox2-asr-main (special tokens + "system"/"user"/"assistant"
...
//
// Usage:
//   cielvox2-asr-test-bpe  cielvox2-asr-0.6b.gguf
...
int main(int argc, char ** argv) {
    if (argc < 2) {
        fprintf(stderr, "usage: %s cielvox2-asr-0.6b.gguf\n", argv[0]);
        return 1;
    }
    ...
    // Reference IDs from the hardcoded build_prompt_ids in cielvox2-asr-main:
    //   <|im_start|> system \n <|im_end|> \n
    //   <|im_start|> user \n
