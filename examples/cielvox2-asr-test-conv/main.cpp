...
// computation; they now go through the shared stelnettts_diff::Ref
// harness defined in examples/cli/stelnettts_diff.{h,cpp}.
//
// Reference archive is produced by:
//
//   python tools/dump_reference.py --backend qwen3 \
//       --model-dir /path/to/hf/cielvox2-asr-0.6b \
//       --audio samples/jfk.wav \
//       --output /tmp/qwen3-ref.gguf
//
// Usage:
//   cielvox2-asr-test-conv cielvox2-asr-0.6b.gguf /tmp/qwen3-ref.gguf
...
int main(int argc, char ** argv) {
    if (argc < 3) {
        fprintf(stderr,
                "usage: %s cielvox2-asr-0.6b.gguf reference.gguf\n"
                "\n"
