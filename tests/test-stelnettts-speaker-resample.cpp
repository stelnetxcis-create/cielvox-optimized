// test-stelnettts-speaker-resample.cpp — unit tests for the pre-resample math
// inside stelnettts_speaker_play().
//
// stelnettts_speaker_play() converts app PCM (e.g. 24 kHz mono from a TTS
...
// Exact copy of the pre-resample logic from stelnettts_speaker_play() so we
// can test it without an audio device (STELNETTTS_SPEAKER_STUB_ONLY would
