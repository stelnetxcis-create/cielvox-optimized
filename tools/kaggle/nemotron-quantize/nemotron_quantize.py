"""
StelnetTTS — Nemotron GGUF quantization + HF upload

Downloads the F16 GGUF, quantizes to Q8_0 and Q4_K using stelnettts-quantize,
and uploads all three to Xenna/nemotron-3.5-asr-streaming-GGUF.
...
# ── Build quantize tool only (much faster than full stelnettts) ──
print("[2/5] Building stelnettts-quantize...", flush=True)
...
quantize_bin = str(BUILD / "bin" / "stelnettts-quantize")
