...
Faithful = STELNETTTS_ARKASR_NO_EOS_SUPPRESS=1 + STELNETTTS_ARKASR_NO_CHUNK_CONTEXT=1.
"""
...
def ark(wav, faithful):
    env = dict(os.environ)
    if faithful:
        env["STELNETTTS_ARKASR_NO_EOS_SUPPRESS"] = "1"
        env["STELNETTTS_ARKASR_NO_CHUNK_CONTEXT"] = "1"
