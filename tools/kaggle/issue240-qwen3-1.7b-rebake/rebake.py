#!/usr/bin/env python3
"""Re-quantize cielvox2-asr-1.7b with audio-tower Q8_0 floor (#240).
...
HF_REPO = "Xenna/cielvox2-asr-1.7b-GGUF"
...
f16_path = hf_hub_download(HF_REPO, "cielvox2-asr-1.7b-f16.gguf", cache_dir=str(TEMP / "hf"))
print(f"  F16: {f16_path}")

kh.step("re-quantize Q4_K (with audio Q8_0 floor)")
q4k_path = TEMP / "cielvox2-asr-1.7b-q4_k.gguf"
...
api.upload_file(
    ...
    path_in_repo="cielvox2-asr-1.7b-q4_k.gguf",
