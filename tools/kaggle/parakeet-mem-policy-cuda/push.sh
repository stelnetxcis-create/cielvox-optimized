...
# (STELNETTTS_REF, default main). Usage: bash tools/kaggle/parakeet-mem-policy-cuda/push.sh
set -euo pipefail
...
echo "Monitor:  kaggle kernels status chr1str/stelnettts-parakeet-mem-policy-cuda"
echo "Output:   kaggle kernels output chr1str/stelnettts-parakeet-mem-policy-cuda -p ./out"
