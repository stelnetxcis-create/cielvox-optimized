"""
StelnetTTS — LFM2-Audio GPU end-to-end test
...
Models:
  - Xenna/lfm2-audio-1.5b-GGUF/lfm2-audio-1.5b-q5_k.gguf (~1.6 GB)
  - Xenna/lfm2-audio-1.5b-jp-GGUF/lfm2-audio-1.5b-jp-q4_k.gguf (~1.5 GB)
  - Xenna/lfm2-audio-1.5b-GGUF/lfm2-audio-1.5b-f16-detokenizer.gguf (~157 MB)
  - Xenna/lfm2-audio-1.5b-jp-GGUF/lfm2-audio-1.5b-jp-f16-detokenizer.gguf (~157 MB)
"""
...
en_model = Path(hf_hub_download(
    "Xenna/lfm2-audio-1.5b-GGUF", "lfm2-audio-1.5b-q5_k.gguf",
    cache_dir=str(MODELS), token=token,
))
en_detok = Path(hf_hub_download(
    "Xenna/lfm2-audio-1.5b-GGUF", "lfm2-audio-1.5b-f16-detokenizer.gguf",
    cache_dir=str(MODELS), token=token,
))
...
jp_model = Path(hf_hub_download(
    "Xenna/lfm2-audio-1.5b-jp-GGUF", "lfm2-audio-1.5b-jp-q4_k.gguf",
    cache_dir=str(MODELS), token=token,
))
jp_detok = Path(hf_hub_download(
    "Xenna/lfm2-audio-1.5b-jp-GGUF", "lfm2-audio-1.5b-jp-f16-detokenizer.gguf",
    cache_dir=str(MODELS), token=token,
))
