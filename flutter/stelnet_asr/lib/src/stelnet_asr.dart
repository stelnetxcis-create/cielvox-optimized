...
class Word {
  ...
  /// session or `stelnet_asr_params_set_alt_n` on the low-level path)
  /// AND the loaded libstelnet_asr is ≥ 0.5.13. Empty otherwise. Ordered
...
/// Result of [StelnetASR.detectLanguage].
...
///
/// Throws when the loaded dylib is pre-0.4.1 (no `stelnet_asr_audio_load`
...
DecodedAudio decodeAudioFile(String path, {String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_audio_load')) {
    throw UnsupportedError(
        'Audio decoder not available in the loaded StelnetASR library — '
  ...
  final free = lib.lookupFunction<Void Function(Pointer<Float>),
      void Function(Pointer<Float>)>('stelnet_asr_audio_free');
  ...
  try {
    ...
    if (rc != 0) {
      throw Exception('stelnet_asr_audio_load failed (code $rc) for $path');
    }
...
/// Identify the language of [text] in-process via StelnetASR's text-LID
/// C-ABI (`stelnet_asr_text_detect_language`, wrapping the CLD3 / GlotLID
...
/// [StelnetASR.detectLanguage] / [LidService], which run AUDIO LID on PCM.
TextLanguage? detectTextLanguage(
  ...
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_text_detect_language')) return null;
  final fn = lib.lookupFunction<
      ...
      int Function(Pointer<Utf8>, Pointer<Utf8>, int, Pointer<Utf8>, int,
          Pointer<Float>)>('stelnet_asr_text_detect_language');
...
bool diarizeSegments({
  ...
  lib ??= DynamicLibrary.open(StelnetASR.defaultLibName());
  ...
  // ABI struct layout must match `stelnet_asr_diarize_seg_abi`:
  ...
  // `stelnet_asr_diarize_opts_abi` in src/stelnet_asr_c_api.cpp. The C side reads
  ...
  final fn = lib.lookupFunction<
      ...
      int Function(Pointer<Float>, Pointer<Float>, int, int, Pointer<Uint8>,
          int, Pointer<Uint8>)>('stelnet_asr_diarize_segments_abi');
  final rc =
...
RegistryEntry? registryLookup(String backend, {DynamicLibrary? lib}) =>
    _registryCall('stelnet_asr_registry_lookup_abi', backend, lib);
...
RegistryEntry? registryLookupByFilename(String filename,
        {DynamicLibrary? lib}) =>
    _registryCall('stelnet_asr_registry_lookup_by_filename_abi', filename, lib);
...
RegistryBundle? registryDefaultBundle(String backend, {DynamicLibrary? lib}) {
  ...
  lib ??= DynamicLibrary.open(StelnetASR.defaultLibName());
  const infoSymbol = 'stelnet_asr_registry_default_bundle_info_abi';
  const artifactSymbol = 'stelnet_asr_registry_default_bundle_artifact_abi';
...
List<String> listKnownModels({DynamicLibrary? lib}) {
  lib ??= DynamicLibrary.open(StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_registry_list_backends_abi')) {
    return const [];
  }
  final fn = lib.lookupFunction<Int32 Function(Pointer<Uint8>, Int32),
      int Function(Pointer<Uint8>, int)>('stelnet_asr_registry_list_backends_abi');
...
class Mic {
  ...
  static Mic open({
    ...
    lib ??= DynamicLibrary.open(StelnetASR.defaultLibName());
    if (!lib.providesSymbol('stelnet_asr_mic_open')) {
      throw UnsupportedError('mic API not present in this libstelnet_asr build');
    }
    ...
    final fn = lib.lookupFunction<
        ...
        Pointer<Void> Function(
            ...
            Pointer<Void>)>('stelnet_asr_mic_open');
    final h = fn(sampleRate, channels, trampoline.nativeFunction, nullptr);
    if (h == nullptr) {
      trampoline.close();
      throw Exception('stelnet_asr_mic_open failed');
    }
  ...
  void start() {
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_mic_start');
    final rc = fn(_handle);
  ...
  void stop() {
    if (!_started) return;
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_mic_stop');
    fn(_handle);
    _started = false;
  }
  ...
  void close() {
    ...
    final fn = _lib.lookupFunction<Void Function(Pointer<Void>),
        void Function(Pointer<Void>)>('stelnet_asr_mic_close');
    fn(_handle);
    _handle = nullptr;
    _trampoline.close();
  }
...
String micDefaultDeviceName({DynamicLibrary? lib}) {
  lib ??= DynamicLibrary.open(StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_mic_default_device_name')) return '';
  final fn =
      lib.lookupFunction<Pointer<Utf8> Function(), Pointer<Utf8> Function()>(
          'stelnet_asr_mic_default_device_name');
  final p = fn();
  if (p == nullptr) return '';
...
/// (`~/.cache/stelnet_asr` on POSIX). Flutter / mobile callers that want
...
String? cacheEnsureFile(
  ...
  final fn = lib.lookupFunction<
      ...
      int Function(Pointer<Utf8>, Pointer<Utf8>, int, Pointer<Utf8>,
          Pointer<Uint8>, int)>('stelnet_asr_cache_ensure_file_abi');
...
String? cacheDir({String? override, DynamicLibrary? lib}) {
  ...
  final fn = lib.lookupFunction<
      ...
      int Function(
          Pointer<Utf8>, Pointer<Uint8>, int)>('stelnet_asr_cache_dir_abi');
...
List<AlignedWord> alignWords({
  ...
  final fn = lib.lookupFunction<
      ...
      Pointer<Void> Function(Pointer<Utf8>, Pointer<Utf8>, Pointer<Float>, int,
          int, int)>('stelnet_asr_align_words_abi');
  final res = fn(
  ...
  final nFn = lib.lookupFunction<Int32 Function(Pointer<Void>),
      int Function(Pointer<Void>)>('stelnet_asr_align_result_n_words');
  final textFn = lib.lookupFunction<
      Pointer<Utf8> Function(Pointer<Void>, Int32),
      Pointer<Utf8> Function(
          Pointer<Void>, int)>('stelnet_asr_align_result_word_text');
  final t0Fn = lib.lookupFunction<Int64 Function(Pointer<Void>, Int32),
      int Function(Pointer<Void>, int)>('stelnet_asr_align_result_word_t0');
  final t1Fn = lib.lookupFunction<Int64 Function(Pointer<Void>, Int32),
      int Function(Pointer<Void>, int)>('stelnet_asr_align_result_word_t1');
  final freeFn = lib.lookupFunction<Void Function(Pointer<Void>),
      void Function(Pointer<Void>)>('stelnet_asr_align_result_free');
...
enum LidMethod {
  ...
  /// the same `stelnet_asr_detect_language_pcm` C ABI; needs
...
LidResult detectLanguagePcm({
  ...
  final fn = lib.lookupFunction<
      ...
      int Function(Pointer<Float>, int, int, Pointer<Utf8>, int, int, int, int,
          Pointer<Uint8>, int, Pointer<Float>)>('stelnet_asr_detect_language_pcm');
...
/// per call inside libstelnet_asr, so this is safe to invoke from
/// concurrent worker isolates.
///
/// Throws [UnsupportedError] when the loaded dylib predates 0.5.12
/// (i.e. doesn't expose `stelnet_asr_enhance_audio_rnnoise`), letting
...
Float32List enhanceAudioRnnoise(
  ...
  lib ??= DynamicLibrary.open(StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_enhance_audio_rnnoise')) {
    throw UnsupportedError(
        'stelnet_asr_enhance_audio_rnnoise not present in this libstelnet_asr build — '
        'rebuild against StelnetASR 0.5.12+');
  }

  final fn = lib.lookupFunction<
      Int32 Function(Pointer<Float>, Int32, Pointer<Float>, Int32),
      int Function(Pointer<Float>, int, Pointer<Float>,
          int)>('stelnet_asr_enhance_audio_rnnoise');
  ...
  try {
    ...
    if (rc != 0) {
      throw StateError('stelnet_asr_enhance_audio_rnnoise failed (rc=$rc)');
    }
...
/// Tunables for [StelnetAsrSession.transcribeVad]. Field names and defaults
/// mirror stelnet_asr's `whisper_vad_params` plus the max-chunk fallback
...
class SessionVadOptions {
  ...
  /// speech regions. stelnet_asr ships 0.5.
...
/// One decoded segment from [StelnetAsrSession.transcribe]. Similar to the
...
/// data2vec, or canary-ctc) by [StelnetAsrSession.transcribeWithLogits].
///
...
/// A speech span returned by [StelnetASR.vad].
class VadSpan {
  final double start; // seconds
  final double end; // seconds
...
/// Options controlling a call to [StelnetASR.transcribePcm].
///
...
class TranscribeOptions {
  ...
  // --- VAD (Silero, built into stelnet_asr). Set [vad] + [vadModelPath]
...
///
/// ```dart
/// final model = StelnetASR('ggml-base.en.bin');
...
class StelnetASR {
  ...
  StelnetASR(String modelPath, {String? libPath}) {
    ...
    // Prefer the *_by_ref wrappers (StelnetASR ≥0.6.11) that take struct
  ...
  void _tryBindExtended() {
    if (_lib.providesSymbol('stelnet_asr_params_set_language')) {
      _paramsSetLanguage =
          _lib.lookupFunction<_ParamsSetStringNative, _ParamsSetString>(
              'stelnet_asr_params_set_language');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_initial_prompt')) {
      _paramsSetInitialPrompt =
          _lib.lookupFunction<_ParamsSetStringNative, _ParamsSetString>(
              'stelnet_asr_params_set_initial_prompt');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_translate')) {
      _paramsSetTranslate =
          _lib.lookupFunction<_ParamsSetBoolNative, _ParamsSetBool>(
              'stelnet_asr_params_set_translate');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_detect_language')) {
      _paramsSetDetectLanguage =
          _lib.lookupFunction<_ParamsSetBoolNative, _ParamsSetBool>(
              'stelnet_asr_params_set_detect_language');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_token_timestamps')) {
      _paramsSetTokenTimestamps =
          _lib.lookupFunction<_ParamsSetBoolNative, _ParamsSetBool>(
              'stelnet_asr_params_set_token_timestamps');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_n_threads')) {
      _paramsSetNThreads =
          _lib.lookupFunction<_ParamsSetIntNative, _ParamsSetInt>(
              'stelnet_asr_params_set_n_threads');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_max_len')) {
      _paramsSetMaxLen =
          _lib.lookupFunction<_ParamsSetIntNative, _ParamsSetInt>(
              'stelnet_asr_params_set_max_len');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_best_of')) {
      _paramsSetBestOf =
          _lib.lookupFunction<_ParamsSetIntNative, _ParamsSetInt>(
              'stelnet_asr_params_set_best_of');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_split_on_word')) {
      _paramsSetSplitOnWord =
          _lib.lookupFunction<_ParamsSetBoolNative, _ParamsSetBool>(
              'stelnet_asr_params_set_split_on_word');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_print_realtime')) {
      _paramsSetPrintRealtime =
          _lib.lookupFunction<_ParamsSetBoolNative, _ParamsSetBool>(
              'stelnet_asr_params_set_print_realtime');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_print_progress')) {
      _paramsSetPrintProgress =
          _lib.lookupFunction<_ParamsSetBoolNative, _ParamsSetBool>(
              'stelnet_asr_params_set_print_progress');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_print_timestamps')) {
      _paramsSetPrintTimestamps =
          _lib.lookupFunction<_ParamsSetBoolNative, _ParamsSetBool>(
              'stelnet_asr_params_set_print_timestamps');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_print_special')) {
    ...
    // 0.4.2 — VAD + tdrz.
    if (_lib.providesSymbol('stelnet_asr_params_set_vad')) {
      _paramsSetVad = _lib.lookupFunction<_ParamsSetBoolNative, _ParamsSetBool>(
          'stelnet_asr_params_set_vad');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_vad_model_path')) {
      _paramsSetVadModelPath =
          _lib.lookupFunction<_ParamsSetStringNative, _ParamsSetString>(
              'stelnet_asr_params_set_vad_model_path');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_vad_threshold')) {
      _paramsSetVadThreshold =
          _lib.lookupFunction<_ParamsSetFloatNative, _ParamsSetFloat>(
              'stelnet_asr_params_set_vad_threshold');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_vad_min_speech_ms')) {
      _paramsSetVadMinSpeechMs =
          _lib.lookupFunction<_ParamsSetIntNative, _ParamsSetInt>(
              'stelnet_asr_params_set_vad_min_speech_ms');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_vad_min_silence_ms')) {
      _paramsSetVadMinSilenceMs =
          _lib.lookupFunction<_ParamsSetIntNative, _ParamsSetInt>(
              'stelnet_asr_params_set_vad_min_silence_ms');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_tdrz')) {
      _paramsSetTdrz =
          _lib.lookupFunction<_ParamsSetBoolNative, _ParamsSetBool>(
              'stelnet_asr_params_set_tdrz');
    }
    ...
    if (_lib.providesSymbol('stelnet_asr_token_t0')) {
      _tokenT0 =
          _lib.lookupFunction<_TokenT0Native, _TokenT0>('stelnet_asr_token_t0');
    }
    if (_lib.providesSymbol('stelnet_asr_token_t1')) {
      _tokenT1 =
          _lib.lookupFunction<_TokenT0Native, _TokenT0>('stelnet_asr_token_t1');
    }
    if (_lib.providesSymbol('stelnet_asr_token_p')) {
      _tokenP = _lib.lookupFunction<_TokenPNative, _TokenP>('stelnet_asr_token_p');
    }
    if (_lib.providesSymbol('stelnet_asr_token_n_alts')) {
      _tokenNAlts = _lib.lookupFunction<_TokenNAltsNative, _TokenNAlts>(
          'stelnet_asr_token_n_alts');
    }
    if (_lib.providesSymbol('stelnet_asr_token_alt_id')) {
      _tokenAltId = _lib.lookupFunction<_TokenAltIdNative, _TokenAltId>(
          'stelnet_asr_token_alt_id');
    }
    if (_lib.providesSymbol('stelnet_asr_token_alt_p')) {
      _tokenAltP = _lib
          .lookupFunction<_TokenAltPNative, _TokenAltP>('stelnet_asr_token_alt_p');
    }
    ...
    if (_lib.providesSymbol('stelnet_asr_params_set_max_tokens')) {
      _paramsSetMaxTokens =
          _lib.lookupFunction<_ParamsSetIntNative, _ParamsSetInt>(
              'stelnet_asr_params_set_max_tokens');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_no_context')) {
      _paramsSetNoContext =
          _lib.lookupFunction<_ParamsSetBoolNative, _ParamsSetBool>(
              'stelnet_asr_params_set_no_context');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_single_segment')) {
      _paramsSetSingleSegment =
          _lib.lookupFunction<_ParamsSetBoolNative, _ParamsSetBool>(
              'stelnet_asr_params_set_single_segment');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_suppress_blank')) {
      _paramsSetSuppressBlank =
          _lib.lookupFunction<_ParamsSetBoolNative, _ParamsSetBool>(
              'stelnet_asr_params_set_suppress_blank');
    }
    if (_lib.providesSymbol('stelnet_asr_params_set_temperature')) {
    ...
    if (_lib.providesSymbol('stelnet_asr_vad_slices')) {
      _vadSlices = _lib
          .lookupFunction<_VadSlicesNative, _VadSlices>('stelnet_asr_vad_slices');
    }
  }
  ...
  List<VadSpan> vad(
    ...
    if (_vadSegments == null || _vadFree == null) {
      throw UnsupportedError(
          'VAD helpers not available — rebuild StelnetASR with 0.2.0+ helpers.');
    }
  ...
  /// Run StelnetASR's unified VAD dispatcher on [pcm]. Returns speech spans
  ...
  List<VadSpan> vadSlices(
    ...
    if (_vadSlices == null || _vadFree == null) {
      throw UnsupportedError(
          'VAD slices helper not available — rebuild StelnetASR with 0.6.0+ helpers.');
    }
    final samples = calloc<Float>(pcm.length);
    for (var i = 0; i < pcm.length; i++) {
      samples[i] = pcm[i];
  ...
  /// text.
  ///
  /// Uses stelnet_asr's sliding-window trick: every [stepMs] of fresh
  ...
  StreamingSession openStream({
    ...
    if (_streamOpen == null ||
        ...
        _streamClose == null) {
      throw UnsupportedError(
          'Streaming helpers not available — rebuild StelnetASR with 0.3.0+.');
    }
    ...
    if (handle == nullptr) {
      throw Exception('stelnet_asr_stream_open returned null');
    }
  ...
  void _checkDisposed() {
    if (_disposed) throw StateError('StelnetASR has been disposed');
  }

  static String _findLib() => defaultLibName();

  /// Platform-default filename for the StelnetASR shared library.
  ///
  /// As of StelnetASR 0.4.0 the build produces both `libstelnet_asr.*`
  ...
  static List<String> _libCandidates() {
    if (Platform.isAndroid || Platform.isLinux) {
      return ['libstelnet_asr.so', 'libwhisper.so'];
    }
    if (Platform.isIOS || Platform.isMacOS) {
      return [
        'libstelnet_asr.dylib',
        'stelnet_asr.framework/stelnet_asr',
        'libwhisper.dylib',
        'whisper.framework/whisper',
      ];
    }
    if (Platform.isWindows) {
      return ['stelnet_asr.dll', 'whisper.dll'];
    }
    return ['libstelnet_asr.so', 'libwhisper.so'];
  }
}

/// A live streaming decode session, created via [StelnetASR.openStream].
///
...
class StreamingSession {
  ...
  StreamingUpdate? feed(Float32List pcm) {
    ...
    try {
      ...
      if (r < 0) throw Exception('stelnet_asr_stream_feed error $r');
  ...
  void setLiveDecode(bool enabled) {
    ...
    if (_setLiveDecodeFn == null) {
      throw UnsupportedError(
          'stelnet_asr_stream_set_live_decode not available in this libstelnet_asr build');
    }
...
//
// The [StelnetASR] class is Whisper-only — it exists for backward
// compatibility and low-overhead direct access to whisper.h. For any new
// client, prefer [StelnetAsrSession]: one constructor, one `transcribe`
...
/// Unified session over any StelnetASR-supported GGUF model.
/// One frame of a pitch (F0) track, as returned by [StelnetAsrSession.pitch].
///
...
/// One detected beat, as returned by [StelnetAsrSession.beats].
///
...
/// One transcribed note, as returned by [StelnetAsrSession.pianoNotes].
///
...
/// One separated source stem, as returned by [StelnetAsrSession.separate].
///
...
///   [StelnetAsrSession.separateSampleRate] (44100 Hz for htdemucs). Length is
///   `2 * framesPerChannel`, the same length as the input passed to
///   [StelnetAsrSession.separate].
///
/// The PCM is Dart-owned: [StelnetAsrSession.separate] copies it out of the
...
class StelnetAsrSession {
  ...
  factory StelnetAsrSession.open(
    ...
    final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
    if (!lib.providesSymbol('stelnet_asr_session_open')) {
      throw UnsupportedError(
          'Unified session API not available — rebuild StelnetASR with 0.4.0+ helpers.');
    }
    ...
    try {
      ...
      if (handle == nullptr) {
        throw Exception(
            'stelnet_asr_session_open returned null — either the GGUF backend '
            'isn\'t one of ${_availableBackends(lib).join(", ")} or the '
            'file is unreadable.');
      }
      final backendFn = lib.lookupFunction<
          Pointer<Utf8> Function(Pointer<Void>),
          Pointer<Utf8> Function(Pointer<Void>)>('stelnet_asr_session_backend');
      final bp = backendFn(handle);
      final be = bp == nullptr ? '' : bp.toDartString();
      return StelnetAsrSession._(lib, handle, be);
    } finally {
      calloc.free(pathPtr);
  ...
  /// Open a session with explicit runtime knobs (StelnetASR 0.6.1+).
  ///
  /// Wraps `stelnet_asr_session_open_with_params`. Use this when the host
  ...
  /// (no `stelnet_asr_session_open_with_params` symbol). Falls back to
  /// the regular [open] in that case via the binding's caller, not
  /// here.
  factory StelnetAsrSession.openWithParams(
    String modelPath, {
    int nThreads = 4,
    bool useGpu = true,
    int verbosity = 0,

    /// StelnetASR 0.6.2+: enable flash-attention on backends that have
    /// a flash-attn path (whisper today; LLM backends incrementally).
    /// Defaults true to match the ggml convention.
    bool flashAttn = true,

    /// StelnetASR 0.6.2+: cap on GPU-offloaded transformer layers for
    ...
    final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
    if (!lib.providesSymbol('stelnet_asr_session_open_with_params')) {
      throw UnsupportedError(
          'stelnet_asr_session_open_with_params missing — needs StelnetASR 0.6.1+. '
          'Use StelnetAsrSession.open() for older builds.');
    }
    // ABI struct layout (see stelnet_asr_open_params_v1 in
    // src/stelnet_asr_c_api.cpp): int32 abi_version, n_threads, use_gpu,
    ...
    try {
      final fn = lib.lookupFunction<
          ...
          Pointer<Void> Function(Pointer<Utf8>, Pointer<Utf8>,
              Pointer<Uint8>)>('stelnet_asr_session_open_with_params');
      final handle = fn(pathPtr, bePtr.cast<Utf8>(), paramsPtr);
      if (handle == nullptr) {
        throw Exception(
            'stelnet_asr_session_open_with_params returned null — either the '
  ...
  static List<String> _availableBackends(DynamicLibrary lib) {
    if (!lib.providesSymbol('stelnet_asr_session_available_backends')) {
      return const [];
    }
    final fn = lib.lookupFunction<
        Int32 Function(Pointer<Utf8>, Int32),
        int Function(
            Pointer<Utf8>, int)>('stelnet_asr_session_available_backends');
    ...
    // the list at "omn" once StelnetASR crossed ~30 backends — every
  ...
  String detectedLanguage() {
    if (!_lib.providesSymbol('stelnet_asr_session_detected_language')) {
      return 'unknown';
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Utf8>, Int32),
        int Function(Pointer<Void>, Pointer<Utf8>,
            int)>('stelnet_asr_session_detected_language');
  ...
  List<SessionSegment> transcribe(Float32List pcm, {String? language}) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    ...
    if (res == nullptr) {
      ...
      throw Exception('stelnet_asr_session_transcribe returned null');
    }
  ...
  (List<SessionSegment>, CtcLogits?) transcribeWithLogits(
    ...
    if (!_lib.providesSymbol('stelnet_asr_session_result_logits')) {
  ...
  /// [transcribe] if the loaded libstelnet_asr predates the chunked entry point.
  List<SessionSegment> transcribeChunked(
    ...
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (pcm.isEmpty) return const [];
    if (!_lib.providesSymbol('stelnet_asr_session_transcribe_chunked_lang')) {
    ...
    final fn = _lib.lookupFunction<
      ...
      'stelnet_asr_session_transcribe_chunked_lang',
    );
    final res =
    ...
    if (langPtr != nullptr) calloc.free(langPtr);
    if (res == nullptr) {
      throw Exception('stelnet_asr_session_transcribe_chunked returned null');
    }
  ...
  List<SessionSegment> transcribeVad(
    ...
    // ABI struct layout must match stelnet_asr_vad_abi_opts in stelnet_asr_c_api.cpp.
    ...
    if (langPtr != null) calloc.free(langPtr);
    if (res == nullptr) {
      throw Exception('stelnet_asr_session_transcribe_vad returned null');
    }
    ...
    try {
      ...
      final freeFn = _lib.lookupFunction<Void Function(Pointer<Void>),
          void Function(Pointer<Void>)>('stelnet_asr_session_result_free');
      freeFn(res);
    }
  }
  ...
  List<SessionSegment> _readSegments(Pointer<Void> res) {
    final nSegs = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_result_n_segments')(res);
    ...
    final segT0 = _lib.lookupFunction<Int64 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_result_segment_t0');
    final segT1 = _lib.lookupFunction<Int64 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_result_segment_t1');
    // Per-segment no_speech_prob (Whisper). Probe like word_p — older dylibs
    // lack the symbol; fall back to the -1.0 "no data" sentinel.
    final segNSPFn =
        _lib.providesSymbol('stelnet_asr_session_result_segment_no_speech_prob')
            ? _lib.lookupFunction<
                Float Function(Pointer<Void>, Int32),
                double Function(Pointer<Void>,
                    int)>('stelnet_asr_session_result_segment_no_speech_prob')
            : null;
    // #300: native per-segment speaker label; probe like the others so a
    // newer package keeps working against an older dylib.
    final segSpkFn = _lib
            .providesSymbol('stelnet_asr_session_result_segment_speaker')
        ? _lib.lookupFunction<
            Pointer<Utf8> Function(Pointer<Void>, Int32),
            Pointer<Utf8> Function(
                Pointer<Void>, int)>('stelnet_asr_session_result_segment_speaker')
        : null;
    final nWords = _lib.lookupFunction<Int32 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_result_n_words');
    ...
    final wordT0 = _lib.lookupFunction<
        ...
        int Function(
            Pointer<Void>, int, int)>('stelnet_asr_session_result_word_t0');
    final wordT1 = _lib.lookupFunction<
        Int64 Function(Pointer<Void>, Int32, Int32),
        int Function(
            Pointer<Void>, int, int)>('stelnet_asr_session_result_word_t1');
    // stelnet_asr_session_result_word_p was added 2026-05-02 to surface
    ...
    final wordPFn = _lib.providesSymbol('stelnet_asr_session_result_word_p')
        ? _lib.lookupFunction<
            Float Function(Pointer<Void>, Int32, Int32),
            double Function(
                Pointer<Void>, int, int)>('stelnet_asr_session_result_word_p')
        : null;
    ...
    final wordNAltsFn = _lib
            .providesSymbol('stelnet_asr_session_result_word_n_alts')
        ? _lib.lookupFunction<
            Int32 Function(Pointer<Void>, Int32, Int32),
            int Function(
                Pointer<Void>, int, int)>('stelnet_asr_session_result_word_n_alts')
        : null;
    final wordAltTextFn =
        _lib.providesSymbol('stelnet_asr_session_result_word_alt_text')
            ? _lib.lookupFunction<
                Pointer<Utf8> Function(Pointer<Void>, Int32, Int32, Int32),
                Pointer<Utf8> Function(Pointer<Void>, int, int,
                    int)>('stelnet_asr_session_result_word_alt_text')
            : null;
    final wordAltPFn = _lib.providesSymbol('stelnet_asr_session_result_word_alt_p')
        ? _lib.lookupFunction<
            Float Function(Pointer<Void>, Int32, Int32, Int32),
            double Function(Pointer<Void>, int, int,
                int)>('stelnet_asr_session_result_word_alt_p')
        : null;
  ...
  CtcLogits? _readLogits(Pointer<Void> res) {
    final nFramesFn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_result_n_logit_frames');
    final nVocabFn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_result_n_logit_vocab');
    final logitsFn = _lib.lookupFunction<
        Pointer<Float> Function(Pointer<Void>),
        Pointer<Float> Function(
            Pointer<Void>)>('stelnet_asr_session_result_logits');
  ...
  List<String>? ctcVocab() {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_token_text')) return null;
    final nVocabFn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_n_vocab');
    final tokenTextFn = _lib.lookupFunction<
        Pointer<Utf8> Function(Pointer<Void>, Int32),
        Pointer<Utf8> Function(
            Pointer<Void>, int)>('stelnet_asr_session_token_text');
  ...
  void setCodecPath(String path) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_codec_path')) {
      throw UnsupportedError(
          'TTS codec API not available in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Utf8>),
        int Function(
            Pointer<Void>, Pointer<Utf8>)>('stelnet_asr_session_set_codec_path');
  ...
  void clearPhonemeCache() {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_kokoro_clear_phoneme_cache')) {
      return; // older libstelnet_asr build — no-op
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>),
        int Function(
            Pointer<Void>)>('stelnet_asr_session_kokoro_clear_phoneme_cache');
    final rc = fn(_handle);
  ...
  void setSourceLanguage(String lang) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_source_language')) {
      throw UnsupportedError(
          'session-state API not present in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Utf8>),
        int Function(Pointer<Void>,
            Pointer<Utf8>)>('stelnet_asr_session_set_source_language');
  ...
  void setTargetLanguage(String lang) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_target_language')) {
      throw UnsupportedError(
          'session-state API not present in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Utf8>),
        int Function(Pointer<Void>,
            Pointer<Utf8>)>('stelnet_asr_session_set_target_language');
    final p = lang.toNativeUtf8();
    try {
      final rc = fn(_handle, p);
  ...
  void setTtsReferenceLanguage(String lang) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_tts_reference_language')) {
      throw UnsupportedError(
          'session-state API not present in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Utf8>),
        int Function(Pointer<Void>,
            Pointer<Utf8>)>('stelnet_asr_session_set_tts_reference_language');
    final p = lang.toNativeUtf8();
    try {
      final rc = fn(_handle, p);
  ...
  void setPunctuation(bool enable) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_punctuation')) {
      throw UnsupportedError(
          'session-state API not present in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_set_punctuation');
  ...
  void setPuncModel(String model) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_punc_model')) {
      throw UnsupportedError(
          'punc-model API not present in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Utf8>),
        int Function(
            Pointer<Void>, Pointer<Utf8>)>('stelnet_asr_session_set_punc_model');
  ...
  void setG2pDict(String source) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_g2p_dict')) {
      throw UnsupportedError(
          'stelnet_asr_session_set_g2p_dict not present in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Utf8>),
        int Function(
            Pointer<Void>, Pointer<Utf8>)>('stelnet_asr_session_set_g2p_dict');
  ...
  void setTranslate(bool enable) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_translate')) {
      throw UnsupportedError(
          'session-state API not present in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_set_translate');
    final rc = fn(_handle, enable ? 1 : 0);
  ...
  void setAsk(String prompt) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_ask')) {
      throw UnsupportedError(
          'setAsk API not present in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Pointer<Utf8>),
        int Function(Pointer<Void>, Pointer<Utf8>)>('stelnet_asr_session_set_ask');
  ...
  void setBestOf(int n) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_best_of')) {
      throw UnsupportedError(
          'stelnet_asr_session_set_best_of not present in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_set_best_of');
  ...
  void setBeamSize(int n) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_beam_size')) {
      throw UnsupportedError(
          'stelnet_asr_session_set_beam_size not present in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_set_beam_size');
    final rc = fn(_handle, n);
  ...
  void setReturnLogits(bool enable) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_return_logits')) {
      throw UnsupportedError(
          'stelnet_asr_session_set_return_logits not present in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_set_return_logits');
    final rc = fn(_handle, enable ? 1 : 0);
  ...
  /// dylib predates 0.5.9 (no `stelnet_asr_session_set_grammar_text`
  ...
  void setGrammar(String text,
    ...
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_grammar_text')) {
      throw UnsupportedError(
          'stelnet_asr_session_set_grammar_text not present in this libstelnet_asr build — '
          'rebuild against StelnetASR 0.5.9+');
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Utf8>, Pointer<Utf8>, Float),
        int Function(Pointer<Void>, Pointer<Utf8>, Pointer<Utf8>,
            double)>('stelnet_asr_session_set_grammar_text');
    final textPtr =
  ...
  /// other backends silently ignore). Effective on StelnetASR
  /// 0.5.11+.
  ///
  ...
  /// 0.5.11 (no `stelnet_asr_session_set_whisper_decode_extras`
  ...
  void setWhisperDecodeExtras({
    ...
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_whisper_decode_extras')) {
      throw UnsupportedError(
          'stelnet_asr_session_set_whisper_decode_extras not present in this libstelnet_asr build — '
          'rebuild against StelnetASR 0.5.11+');
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Int32, Pointer<Utf8>, Int32),
        int Function(Pointer<Void>, int, Pointer<Utf8>,
            int)>('stelnet_asr_session_set_whisper_decode_extras');
  ...
  /// predates 0.5.10 (no `stelnet_asr_session_set_fallback_thresholds`
  ...
  void setFallbackThresholds({
    ...
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_fallback_thresholds')) {
      throw UnsupportedError(
          'stelnet_asr_session_set_fallback_thresholds not present in this libstelnet_asr build — '
          'rebuild against StelnetASR 0.5.10+');
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Float, Float, Float, Float),
        int Function(Pointer<Void>, double, double, double,
            double)>('stelnet_asr_session_set_fallback_thresholds');
    final rc =
  ...
  /// (no `stelnet_asr_session_set_alt_n` symbol). Callers should catch
  /// and downgrade gracefully — the C side wouldn't have honoured
  /// the value anyway.
  void setAltN(int n) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_alt_n')) {
      throw UnsupportedError(
          'stelnet_asr_session_set_alt_n not present in this libstelnet_asr build — '
          'rebuild against StelnetASR 0.5.13+');
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_set_alt_n');
    final rc = fn(_handle, n);
    if (rc != 0) {
  ...
  void setTemperature(double temperature, {int seed = 0}) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_temperature')) {
      throw UnsupportedError(
          'session-state API not present in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<
        ...
        int Function(
            Pointer<Void>, double, int)>('stelnet_asr_session_set_temperature');
  ...
  void setTtsSteps(int steps) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_tts_steps')) {
      // Older libstelnet_asr without the symbol — silent no-op so the
      // UI slider still works when bound against pre-0.6.1 dylibs.
      return;
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_set_tts_steps');
  ...
  void setTtsNumCandidates(int n) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_tts_num_candidates')) {
      // Older libstelnet_asr without the symbol — silent no-op.
      return;
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Int32),
        int Function(
            Pointer<Void>, int)>('stelnet_asr_session_set_tts_num_candidates');
    final rc = fn(_handle, n);
    if (rc != 0 && rc != -2) {
  ...
  void setTopP(double topP) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_top_p')) return;
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Float),
        int Function(Pointer<Void>, double)>('stelnet_asr_session_set_top_p');
  ...
  void setTopK(int topK) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_top_k')) return;
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_set_top_k');
  ...
  void setDoSample(bool enable) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_do_sample')) return;
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_set_do_sample');
    final rc = fn(_handle, enable ? 1 : 0);
  ...
  void setMinP(double minP) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_min_p')) return;
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Float),
        int Function(Pointer<Void>, double)>('stelnet_asr_session_set_min_p');
  ...
  void setRepetitionPenalty(double r) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_repetition_penalty')) return;
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Float),
        int Function(
            Pointer<Void>, double)>('stelnet_asr_session_set_repetition_penalty');
  ...
  void setCfgWeight(double cfg) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_cfg_weight')) return;
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Float),
        int Function(Pointer<Void>, double)>('stelnet_asr_session_set_cfg_weight');
  ...
  void setTtsNoiseTemp(double noiseTemp) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_tts_noise_temp')) return;
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Float),
        int Function(
            Pointer<Void>, double)>('stelnet_asr_session_set_tts_noise_temp');
  ...
  void setExaggeration(double exaggeration) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_exaggeration')) return;
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Float),
        int Function(
            Pointer<Void>, double)>('stelnet_asr_session_set_exaggeration');
  ...
  void setMaxSpeechTokens(int n) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_max_speech_tokens')) return;
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Int32),
        int Function(
            Pointer<Void>, int)>('stelnet_asr_session_set_max_speech_tokens');
    final rc = fn(_handle, n);
    if (rc != 0 && rc != -2) {
  ...
  void setMinSpeechTokens(int n) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_min_speech_tokens')) return;
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Int32),
        int Function(
            Pointer<Void>, int)>('stelnet_asr_session_set_min_speech_tokens');
    final rc = fn(_handle, n);
    if (rc != 0 && rc != -2) {
  ...
  void setLengthScale(double scale) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_length_scale')) return;
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Float),
        int Function(
            Pointer<Void>, double)>('stelnet_asr_session_set_length_scale');
  ...
  void setTtsSeed(int seed) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_tts_seed')) return;
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Uint64),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_set_tts_seed');
  ...
  void setMaxNewTokens(int n) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_max_new_tokens')) return;
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Int32),
        int Function(
            Pointer<Void>, int)>('stelnet_asr_session_set_max_new_tokens');
    final rc = fn(_handle, n);
  ...
  void setFrequencyPenalty(double penalty) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_frequency_penalty')) return;
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Float),
        int Function(
            Pointer<Void>, double)>('stelnet_asr_session_set_frequency_penalty');
  ...
  ///
  /// Routes through the C-side `stelnet_asr_session_translate_text`, which
  ...
  String? translateText(String text, String srcLang, String tgtLang,
      {int maxTokens = 0}) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_translate_text')) {
      throw UnsupportedError(
          'translateText not in this libstelnet_asr — needs StelnetASR 0.6.0+');
    }
    final fn = _lib.lookupFunction<
        Pointer<Utf8> Function(
            Pointer<Void>, Pointer<Utf8>, Pointer<Utf8>, Pointer<Utf8>, Int32),
        Pointer<Utf8> Function(Pointer<Void>, Pointer<Utf8>, Pointer<Utf8>,
            Pointer<Utf8>, int)>('stelnet_asr_session_translate_text');
    final freeFn = _lib.providesSymbol('stelnet_asr_session_translate_text_free')
        ? _lib.lookupFunction<
            Void Function(Pointer<Utf8>),
            void Function(
                Pointer<Utf8>)>('stelnet_asr_session_translate_text_free')
        : null;
    final textPtr = text.toNativeUtf8();
  ...
  ({String lang, double confidence}) detectLanguage(
    ...
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_detect_language')) {
      throw UnsupportedError(
          'session-state API not present in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<
        ...
        int Function(
            ...
            Pointer<Utf8>,
            int,
            Pointer<Float>)>('stelnet_asr_session_detect_language');
  ...
  void setVoice(String path, {String? refText}) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_voice')) {
      throw UnsupportedError(
          'TTS voice API not available in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Utf8>, Pointer<Utf8>),
        int Function(Pointer<Void>, Pointer<Utf8>,
            Pointer<Utf8>)>('stelnet_asr_session_set_voice');
    final pathPtr = path.toNativeUtf8();
  ...
  void setSpeakerName(String name) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_speaker_name')) {
      throw UnsupportedError(
          'setSpeakerName API not available in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Utf8>),
        int Function(
            Pointer<Void>, Pointer<Utf8>)>('stelnet_asr_session_set_speaker_name');
  ...
  List<String> speakers() {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_n_speakers')) return const [];
    final nFn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_n_speakers');
    final getFn = _lib.lookupFunction<
        Pointer<Utf8> Function(Pointer<Void>, Int32),
        Pointer<Utf8> Function(
            Pointer<Void>, int)>('stelnet_asr_session_get_speaker_name');
    final n = nFn(_handle);
    final out = <String>[];
    for (var i = 0; i < n; i++) {
  ...
  void setSpeakerID(int id) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_speaker_id')) {
      throw UnsupportedError(
          'setSpeakerID API not available in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_session_set_speaker_id');
  ...
  int get nSpeakers {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_n_speakers')) return 0;
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_n_speakers');
    return fn(_handle);
  }
  ...
  void setInstruct(String instruct) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_instruct')) {
      throw UnsupportedError(
          'setInstruct API not available in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Utf8>),
        int Function(
            Pointer<Void>, Pointer<Utf8>)>('stelnet_asr_session_set_instruct');
  ...
  void setTtsPhonemes(String phonemes) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_tts_phonemes')) {
      throw UnsupportedError(
          'setTtsPhonemes API not available in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Utf8>),
        int Function(
            Pointer<Void>, Pointer<Utf8>)>('stelnet_asr_session_set_tts_phonemes');
  ...
  bool isCustomVoice() {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_is_custom_voice')) return false;
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_is_custom_voice');
    return fn(_handle) != 0;
  }
  ...
  bool isVoiceDesign() {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_is_voice_design')) return false;
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_is_voice_design');
    return fn(_handle) != 0;
  }
  ...
  Float32List synthesize(String text) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_synthesize')) {
      throw UnsupportedError(
          'TTS synthesize API not available in this libstelnet_asr build');
    }
    final synFn = _lib.lookupFunction<
        Pointer<Float> Function(Pointer<Void>, Pointer<Utf8>, Pointer<Int32>),
        Pointer<Float> Function(Pointer<Void>, Pointer<Utf8>, Pointer<Int32>)>(
      'stelnet_asr_session_synthesize',
    );
    final freeFn = _lib.lookupFunction<Void Function(Pointer<Float>),
        void Function(Pointer<Float>)>('stelnet_asr_pcm_free');
    final textPtr = text.toNativeUtf8();
    ...
    try {
      ...
      if (pcmPtr == nullptr || n <= 0) {
        ...
        String reason = '';
        if (_lib.providesSymbol('stelnet_asr_session_last_synth_error')) {
          final errFn = _lib.lookupFunction<
              Pointer<Utf8> Function(Pointer<Void>),
              Pointer<Utf8> Function(Pointer<Void>)>(
            'stelnet_asr_session_last_synth_error',
          );
  ...
  void setSpeakerIdentity(String identity) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_speaker_identity')) {
      throw UnsupportedError(
          'speaker-identity API not available in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Pointer<Utf8>),
        int Function(Pointer<Void>, Pointer<Utf8>)>(
      'stelnet_asr_session_set_speaker_identity',
    );
  ...
  void acceptMarkingResponsibility([String attestation = '']) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib
        .providesSymbol('stelnet_asr_session_accept_marking_responsibility')) {
      throw UnsupportedError(
          'marking-attestation API not available in this libstelnet_asr build');
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>, Pointer<Utf8>),
        int Function(Pointer<Void>, Pointer<Utf8>)>(
      'stelnet_asr_session_accept_marking_responsibility',
    );
  ...
  Float32List synthesizeRaw(String text) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_synthesize_raw')) {
      throw UnsupportedError(
          'TTS raw synthesize API not available in this libstelnet_asr build');
    }
    final synFn = _lib.lookupFunction<
        Pointer<Float> Function(Pointer<Void>, Pointer<Utf8>, Pointer<Int32>),
        Pointer<Float> Function(Pointer<Void>, Pointer<Utf8>, Pointer<Int32>)>(
      'stelnet_asr_session_synthesize_raw',
    );
    final freeFn = _lib.lookupFunction<Void Function(Pointer<Float>),
        void Function(Pointer<Float>)>('stelnet_asr_pcm_free');
    final textPtr = text.toNativeUtf8();
  ...
  ({Float32List pcm, String transcript}) speechToSpeech(Float32List inputPcm) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_speech_to_speech')) {
      throw UnsupportedError(
          'speechToSpeech API not available in this libstelnet_asr build');
    }
    final s2sFn = _lib.lookupFunction<
        ...
        Pointer<Float> Function(Pointer<Void>, Pointer<Float>, int,
            Pointer<Pointer<Utf8>>, Pointer<Int32>)>(
      'stelnet_asr_session_speech_to_speech',
    );
    final freeFn = _lib.lookupFunction<Void Function(Pointer<Float>),
        void Function(Pointer<Float>)>('stelnet_asr_pcm_free');
  ...
  ///
  /// ```dart
  /// final s = StelnetAsrSession.open(path, backend: 'crepe');
  /// final track = s.pitch(pcm);
  /// ```
  ///
  /// Passing `backend: 'crepe'` explicitly is the safest form and always
  /// works. Plain [StelnetAsrSession.open] also works from StelnetASR 0.8.15
  ...
  List<PitchFrame> pitch(Float32List pcm16k, {double hopMs = 10.0}) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_pitch')) {
      throw UnsupportedError(
          'Pitch API not available in this libstelnet_asr build');
    }
  ...
  int get pitchSampleRate {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_pitch_sample_rate')) return 0;
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_pitch_sample_rate');
    return fn(_handle);
  }
  ...
  ///
  /// ```dart
  /// final s = StelnetAsrSession.open(path, backend: 'beat-this');
  ...
  List<Beat> beats(Float32List pcm22k) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_beats')) {
      throw UnsupportedError(
          'Beat API not available in this libstelnet_asr build');
    }
    ...
    final beatsFn = _lib.lookupFunction<
      ...
      'stelnet_asr_session_beats',
    );
    final eventsFn = _lib.lookupFunction<
        Pointer<Float> Function(Pointer<Void>, Pointer<Int32>),
        Pointer<Float> Function(Pointer<Void>, Pointer<Int32>)>(
      'stelnet_asr_session_beats_events',
    );
  ...
  int get beatsSampleRate {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_beats_sample_rate')) return 0;
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_beats_sample_rate');
    return fn(_handle);
  }
  ...
  double get beatsTempoBpm {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_beats_tempo_bpm')) return 0.0;
    final fn = _lib.lookupFunction<Float Function(Pointer<Void>),
        double Function(Pointer<Void>)>('stelnet_asr_session_beats_tempo_bpm');
    return fn(_handle);
  }
  ...
  List<Stem> separate(Float32List pcmStereo) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_separate')) {
      throw UnsupportedError(
          'Separation API not available in this libstelnet_asr build');
    }
    ...
    final sepFn = _lib.lookupFunction<
      ...
      'stelnet_asr_session_separate',
    );
    final nameFn = _lib.lookupFunction<
        Pointer<Utf8> Function(Pointer<Void>, Int32),
        Pointer<Utf8> Function(Pointer<Void>, int)>(
      'stelnet_asr_session_separate_stem_name',
    );
    final stemFn = _lib.lookupFunction<
      ...
      'stelnet_asr_session_separate_stem',
    );
  ...
  ///
  /// ```dart
  /// final s = StelnetAsrSession.open(path, backend: 'piano-transcription');
  ...
  List<PianoNote> pianoNotes(Float32List pcm16k) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_piano')) {
      throw UnsupportedError(
          'Piano transcription API not available in this libstelnet_asr build');
    }
    if (pcm16k.isEmpty) return const <PianoNote>[];
    final pianoFn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Float>, Int32),
        int Function(Pointer<Void>, Pointer<Float>, int)>(
      'stelnet_asr_session_piano',
    );
    final notesFn = _lib.lookupFunction<
        Pointer<Float> Function(Pointer<Void>, Pointer<Int32>),
        Pointer<Float> Function(Pointer<Void>, Pointer<Int32>)>(
      'stelnet_asr_session_piano_notes',
    );
    final inPtr = calloc<Float>(pcm16k.length);
    final nPtr = calloc<Int32>();
    try {
  ...
  int get pianoSampleRate {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_piano_sample_rate')) return 0;
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_piano_sample_rate');
    return fn(_handle);
  }
  ...
  int get separateSampleRate {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_separate_sample_rate')) {
      return 0;
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_separate_sample_rate');
    return fn(_handle);
  }
  ...
  int get inputSampleRate {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_input_sample_rate')) {
      return 0;
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_input_sample_rate');
    return fn(_handle);
  }
  ...
  int get outputSampleRate {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_output_sample_rate')) {
      return 0;
    }
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_session_output_sample_rate');
    return fn(_handle);
  }
  ...
  void setHotwords(String hotwords, {double boost = 1.5}) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_hotwords')) {
    ...
    final fn = _lib.lookupFunction<
        ...
        int Function(Pointer<Void>, Pointer<Utf8>,
            double)>('stelnet_asr_session_set_hotwords');
  ...
  void setSensitivity(String preset) {
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_set_sensitivity')) {
      return;
    }
    final fn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Utf8>),
        int Function(
            Pointer<Void>, Pointer<Utf8>)>('stelnet_asr_session_set_sensitivity');
  ...
  ///
  /// Backed by `stelnet_asr_session_stream_open` on the C side, which
  /// dispatches the rolling-window protocol to whichever backend the
  /// session loaded (whisper, kyutai-stt, moonshine-streaming, …).
  /// Same shape as [StelnetASR.openStream] (Whisper-only) but works for
  /// every backend that publishes a streaming entry point.
  ///
  /// Throws [UnsupportedError] when the loaded dylib predates
  /// `stelnet_asr_session_stream_open`, [StateError] when the session
  ...
  StreamingSession openStream({
    ...
    if (_closed) throw StateError('StelnetAsrSession is closed');
    if (!_lib.providesSymbol('stelnet_asr_session_stream_open')) {
      throw UnsupportedError(
          'Session-level streaming not in this libstelnet_asr — needs StelnetASR 0.6+.');
    }
    final fn = _lib.lookupFunction<
        Pointer<Void> Function(
            Pointer<Void>, Int32, Int32, Int32, Int32, Pointer<Utf8>, Int32),
        Pointer<Void> Function(Pointer<Void>, int, int, int, int, Pointer<Utf8>,
            int)>('stelnet_asr_session_stream_open');
    final langPtr = (language == null || language.isEmpty || language == 'auto')
        ? nullptr
        : language.toNativeUtf8();
    ...
    if (handle == nullptr) {
      throw Exception(
          'stelnet_asr_session_stream_open returned null — backend "$_backend" '
          'has no streaming entry point.');
    }
    final feedFn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Float>, Int32),
        int Function(
            Pointer<Void>, Pointer<Float>, int)>('stelnet_asr_stream_feed');
    final flushFn = _lib.providesSymbol('stelnet_asr_stream_flush')
        ? _lib.lookupFunction<Int32 Function(Pointer<Void>),
            int Function(Pointer<Void>)>('stelnet_asr_stream_flush')
        : null;
    final getTextFn = _lib.lookupFunction<
        ...
        int Function(Pointer<Void>, Pointer<Utf8>, int, Pointer<Double>,
            Pointer<Double>, Pointer<Int64>)>('stelnet_asr_stream_get_text');
    final closeFn = _lib.lookupFunction<Void Function(Pointer<Void>),
        void Function(Pointer<Void>)>('stelnet_asr_stream_close');
    final setLiveDecodeFn = _lib
            .providesSymbol('stelnet_asr_stream_set_live_decode')
        ? _lib.lookupFunction<_StreamSetLiveDecodeNative, _StreamSetLiveDecode>(
            'stelnet_asr_stream_set_live_decode')
        : null;
...
class PuncModel {
  ...
  static PuncModel open(String modelPath, {String? libPath}) {
    ...
    final initFn = lib.lookupFunction<Pointer<Void> Function(Pointer<Utf8>),
        Pointer<Void> Function(Pointer<Utf8>)>('stelnet_asr_punc_init');
    final pathPtr = modelPath.toNativeUtf8();
  ...
  String process(String text) {
    ...
    final processFn = _lib.lookupFunction<
        ...
        Pointer<Utf8> Function(
            Pointer<Void>, Pointer<Utf8>)>('stelnet_asr_punc_process');
    final freeFn = _lib.lookupFunction<Void Function(Pointer<Utf8>),
        void Function(Pointer<Utf8>)>('stelnet_asr_punc_free_text');
    final textPtr = text.toNativeUtf8();
  ...
  void close() {
    ...
    _closed = true;
    final freeFn = _lib.lookupFunction<Void Function(Pointer<Void>),
        void Function(Pointer<Void>)>('stelnet_asr_punc_free');
    freeFn(_handle);
    _handle = nullptr;
  }
}
...
class TruecaseModel {
  ...
  static TruecaseModel open(String modelPath, {String? libPath}) {
    final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
    final initFn = lib.lookupFunction<Pointer<Void> Function(Pointer<Utf8>),
        Pointer<Void> Function(Pointer<Utf8>)>('stelnet_asr_truecase_init');
    final pathPtr = modelPath.toNativeUtf8();
    final handle = initFn(pathPtr);
    calloc.free(pathPtr);
    if (handle == nullptr) {
  ...
  String process(String text) {
    ...
    final processFn = _lib.lookupFunction<
        Pointer<Utf8> Function(Pointer<Void>, Pointer<Utf8>),
        Pointer<Utf8> Function(
            Pointer<Void>, Pointer<Utf8>)>('stelnet_asr_truecase_process');
    final freeFn = _lib.lookupFunction<Void Function(Pointer<Utf8>),
        void Function(Pointer<Utf8>)>('stelnet_asr_truecase_free_text');
    final textPtr = text.toNativeUtf8();
    final resultPtr = processFn(_handle, textPtr);
    calloc.free(textPtr);
    if (resultPtr == nullptr) return text;
  ...
  void close() {
    ...
    _closed = true;
    final freeFn = _lib.lookupFunction<Void Function(Pointer<Void>),
        void Function(Pointer<Void>)>('stelnet_asr_truecase_free');
    freeFn(_handle);
    _handle = nullptr;
  }
}
...
class PcsModel {
  ...
  static PcsModel open(String modelPath, {String? libPath}) {
    final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
    final initFn = lib.lookupFunction<Pointer<Void> Function(Pointer<Utf8>),
        Pointer<Void> Function(Pointer<Utf8>)>('stelnet_asr_pcs_init');
    final pathPtr = modelPath.toNativeUtf8();
    final handle = initFn(pathPtr);
    calloc.free(pathPtr);
    if (handle == nullptr) {
  ...
  String process(String text) {
    ...
    final processFn = _lib.lookupFunction<
        Pointer<Utf8> Function(Pointer<Void>, Pointer<Utf8>),
        Pointer<Utf8> Function(
            Pointer<Void>, Pointer<Utf8>)>('stelnet_asr_pcs_process');
    final freeFn = _lib.lookupFunction<Void Function(Pointer<Utf8>),
        void Function(Pointer<Utf8>)>('stelnet_asr_pcs_free_text');
    final textPtr = text.toNativeUtf8();
    final resultPtr = processFn(_handle, textPtr);
    calloc.free(textPtr);
    if (resultPtr == nullptr) return text;
  ...
  void close() {
    ...
    _closed = true;
    final freeFn = _lib.lookupFunction<Void Function(Pointer<Void>),
        void Function(Pointer<Void>)>('stelnet_asr_pcs_free');
    freeFn(_handle);
    _handle = nullptr;
  }
}
...
class StelnetAsrTitaNet {
  late final DynamicLibrary _lib;
  Pointer<Void> _handle = nullptr;

  StelnetAsrTitaNet(DynamicLibrary lib, String modelPath, {int nThreads = 4})
      : _lib = lib {
    final initFn = lib.lookupFunction<
        Pointer<Void> Function(Pointer<Utf8>, Int32),
        Pointer<Void> Function(Pointer<Utf8>, int)>('stelnet_asr_titanet_init');
  ...
  Float32List embed(Float32List pcm16k) {
    final embedFn = _lib.lookupFunction<
        ...
        int Function(Pointer<Void>, Pointer<Float>, int,
            Pointer<Float>)>('stelnet_asr_titanet_embed');
  ...
  static double cosineSim(DynamicLibrary lib, Float32List a, Float32List b) {
    final fn = lib.lookupFunction<
        ...
        double Function(Pointer<Float>, Pointer<Float>,
            int)>('stelnet_asr_titanet_cosine_sim');
  ...
  void close() {
    if (_handle == nullptr) return;
    final freeFn = _lib.lookupFunction<Void Function(Pointer<Void>),
        void Function(Pointer<Void>)>('stelnet_asr_titanet_free');
    freeFn(_handle);
    _handle = nullptr;
  }
}
...
class StelnetAsrSpeakerDB {
  late final DynamicLibrary _lib;
  Pointer<Void> _handle = nullptr;
  final String dirPath;

  StelnetAsrSpeakerDB(DynamicLibrary lib, this.dirPath,
      {required String expectedNames, required bool consentAttested})
      : _lib = lib {
    if (!consentAttested) {
      throw StateError(
          'StelnetAsrSpeakerDB requires an explicit consent attestation (GDPR Art. 9)');
    }
    final openFn = lib.lookupFunction<
        Pointer<Void> Function(Pointer<Utf8>, Pointer<Utf8>, Int32),
        Pointer<Void> Function(
            Pointer<Utf8>, Pointer<Utf8>, int)>('stelnet_asr_speaker_db_open');
  ...
  int get count {
    final countFn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_speaker_db_count');
  ...
  (String?, double) match(Float32List embedding, {double threshold = 0.7}) {
    final matchFn = _lib.lookupFunction<
        ...
        double Function(Pointer<Void>, Pointer<Float>, int, double,
            Pointer<Utf8>, int)>('stelnet_asr_speaker_db_match');
  ...
  bool enroll(String name, Float32List embedding) {
    final enrollFn = _lib.lookupFunction<
        ...
        int Function(Pointer<Utf8>, Pointer<Utf8>, Pointer<Float>, int,
            int)>('stelnet_asr_speaker_db_enroll2');
    final dp = dirPath.toNativeUtf8();
  ...
  void close() {
    if (_handle == nullptr) return;
    final freeFn = _lib.lookupFunction<Void Function(Pointer<Void>),
        void Function(Pointer<Void>)>('stelnet_asr_speaker_db_free');
    freeFn(_handle);
    _handle = nullptr;
  }
}
...
class StelnetAsrSpeakerEmbedder {
  ...
  int get dim {
    final dimFn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_speaker_embedder_dim_abi');
  ...
  String get name {
    final nameFn = _lib.lookupFunction<
        Pointer<Utf8> Function(Pointer<Void>),
        Pointer<Utf8> Function(
            Pointer<Void>)>('stelnet_asr_speaker_embedder_name_abi');
  ...
  Float32List? embed(Float32List pcm16k) {
    final embedFn = _lib.lookupFunction<
        Int32 Function(Pointer<Void>, Pointer<Float>, Int32, Pointer<Float>),
        int Function(Pointer<Void>, Pointer<Float>, int,
            Pointer<Float>)>('stelnet_asr_speaker_embedder_embed_abi');
    final d = dim;
    if (d <= 0) return null;
    final pcmPtr = malloc<Float>(pcm16k.length);
    pcmPtr.asTypedList(pcm16k.length).setAll(0, pcm16k);
  ...
  void close() {
    if (_handle == nullptr) return;
    final freeFn = _lib.lookupFunction<Void Function(Pointer<Void>),
        void Function(Pointer<Void>)>('stelnet_asr_speaker_embedder_free_abi');
    freeFn(_handle);
    _handle = nullptr;
  }
}
...
List<int> stelnet_asrAgglomerativeCluster(
  DynamicLibrary lib,
  ...
  final fn = lib.lookupFunction<
      ...
      int Function(Pointer<Float>, int, int, double, int,
          Pointer<Int32>)>('stelnet_asr_speaker_cluster_abi');
  ...
  malloc.free(outPtr);
  if (rc < 0) {
    throw Exception('stelnet_asr_speaker_cluster_abi: invalid arguments');
  }
  return labels;
}

/// Pre-computed pyannote-seg posteriors over a full audio buffer.
class StelnetAsrPyannoteCache {
  late final DynamicLibrary _lib;
  Pointer<Void> _handle = nullptr;

  StelnetAsrPyannoteCache(
    ...
    final computeFn = lib.lookupFunction<
        ...
        Pointer<Void> Function(Pointer<Float>, int, Pointer<Utf8>,
            int)>('stelnet_asr_pyannote_cache_compute_abi');
    final pcmPtr = malloc<Float>(pcm16k.length);
    pcmPtr.asTypedList(pcm16k.length).setAll(0, pcm16k);
    final mp = modelPath.toNativeUtf8();
  ...
  void apply(List<DiarizeSegment> segs, {double sliceT0 = 0.0}) {
    ...
    final applyFn = _lib.lookupFunction<
        ...
        int Function(Pointer<Void>, int, Pointer<Uint8>,
            int)>('stelnet_asr_pyannote_cache_apply_abi');
    final rc = applyFn(_handle, (sliceT0 * 100).round(), segPtr, segs.length);
    if (rc != 0) {
      malloc.free(segPtr);
      throw Exception('stelnet_asr_pyannote_cache_apply_abi returned $rc');
    }
    for (var i = 0; i < segs.length; i++) {
  ...
  void close() {
    if (_handle == nullptr) return;
    final freeFn = _lib.lookupFunction<Void Function(Pointer<Void>),
        void Function(Pointer<Void>)>('stelnet_asr_pyannote_cache_free_abi');
    freeFn(_handle);
    _handle = nullptr;
  }
}
...
class ParakeetResult {
  ...
  String get text {
    final fn = _lib.lookupFunction<Pointer<Utf8> Function(Pointer<Void>),
        Pointer<Utf8> Function(Pointer<Void>)>('stelnet_asr_parakeet_result_text');
    final p = fn(_handle);
    return p == nullptr ? '' : p.toDartString();
  }
  ...
  int get nWords {
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_parakeet_result_n_words');
    return fn(_handle);
  }
  ...
  String wordText(int i) {
    final fn = _lib.lookupFunction<
        Pointer<Utf8> Function(Pointer<Void>, Int32),
        Pointer<Utf8> Function(
            Pointer<Void>, int)>('stelnet_asr_parakeet_result_word_text');
  ...
  int wordT0(int i) {
    final fn = _lib.lookupFunction<Int64 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_parakeet_result_word_t0');
    return fn(_handle, i);
  }

  int wordT1(int i) {
    final fn = _lib.lookupFunction<Int64 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_parakeet_result_word_t1');
    return fn(_handle, i);
  }

  int get nTokens {
    final fn = _lib.lookupFunction<Int32 Function(Pointer<Void>),
        int Function(Pointer<Void>)>('stelnet_asr_parakeet_result_n_tokens');
    return fn(_handle);
  }
  ...
  String tokenText(int i) {
    final fn = _lib.lookupFunction<
        Pointer<Utf8> Function(Pointer<Void>, Int32),
        Pointer<Utf8> Function(
            Pointer<Void>, int)>('stelnet_asr_parakeet_result_token_text');
    final p = fn(_handle, i);
    return p == nullptr ? '' : p.toDartString();
  }
  ...
  int tokenT0(int i) {
    final fn = _lib.lookupFunction<Int64 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_parakeet_result_token_t0');
    return fn(_handle, i);
  }

  int tokenT1(int i) {
    final fn = _lib.lookupFunction<Int64 Function(Pointer<Void>, Int32),
        int Function(Pointer<Void>, int)>('stelnet_asr_parakeet_result_token_t1');
    return fn(_handle, i);
  }
  ...
  double tokenP(int i) {
    final fn = _lib.lookupFunction<
        Float Function(Pointer<Void>, Int32),
        double Function(
            Pointer<Void>, int)>('stelnet_asr_parakeet_result_token_p');
    return fn(_handle, i);
  }
  ...
  void free() {
    if (_handle == nullptr) return;
    final fn = _lib.lookupFunction<Void Function(Pointer<Void>),
        void Function(Pointer<Void>)>('stelnet_asr_parakeet_result_free');
    fn(_handle);
    _handle = nullptr;
  }
}

/// Direct Parakeet ASR context. For most use cases prefer [StelnetAsrSession]
/// which auto-dispatches to Parakeet when the GGUF metadata indicates it.
class StelnetAsrParakeet {
  late final DynamicLibrary _lib;
  Pointer<Void> _handle = nullptr;

  StelnetAsrParakeet(DynamicLibrary lib, String modelPath,
      {int nThreads = 4, bool useFlash = true})
      : _lib = lib {
    final initFn = lib.lookupFunction<
        Pointer<Void> Function(Pointer<Utf8>, Int32, Int32),
        Pointer<Void> Function(
            Pointer<Utf8>, int, int)>('stelnet_asr_parakeet_init');
    final mp = modelPath.toNativeUtf8();
    ...
    try {
      final fn = _lib.lookupFunction<
          Pointer<Void> Function(
              Pointer<Void>, Pointer<Float>, Int32, Pointer<Utf8>),
          Pointer<Void> Function(Pointer<Void>, Pointer<Float>, int,
              Pointer<Utf8>)>('stelnet_asr_parakeet_transcribe');
      final res = fn(_handle, pcmPtr, pcm16k.length, langPtr.cast<Utf8>());
      if (res == nullptr) {
        throw Exception('stelnet_asr_parakeet_transcribe returned null');
      }
  ...
  void close() {
    if (_handle == nullptr) return;
    final fn = _lib.lookupFunction<Void Function(Pointer<Void>),
        void Function(Pointer<Void>)>('stelnet_asr_parakeet_free');
    fn(_handle);
    _handle = nullptr;
  }
}
...
String? detectBackendFromGguf(String path, {String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_detect_backend_from_gguf')) return null;
  final fn = lib.lookupFunction<
      Int32 Function(Pointer<Utf8>, Pointer<Utf8>, Int32),
      int Function(Pointer<Utf8>, Pointer<Utf8>,
          int)>('stelnet_asr_detect_backend_from_gguf');
  final pathPtr = path.toNativeUtf8();
  const cap = 128;
...
int lcsDedup(DynamicLibrary lib, List<int> prevTailTokens, List<int> currTokens,
  ...
  final fn = lib.lookupFunction<
      ...
      int Function(Pointer<Int32>, int, Pointer<Int32>, int,
          int)>('stelnet_asr_lcs_dedup_prefix_count');
...
bool kokoroLangIsGerman(String lang, {String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_kokoro_lang_is_german_abi')) return false;
  final fn = lib.lookupFunction<Bool Function(Pointer<Utf8>),
      bool Function(Pointer<Utf8>)>('stelnet_asr_kokoro_lang_is_german_abi');
  final p = lang.toNativeUtf8();
  try {
    return fn(p);
  } finally {
...
bool kokoroLangHasNativeVoice(String lang, {String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_kokoro_lang_has_native_voice_abi')) {
    return false;
  }
  final fn = lib.lookupFunction<
      Bool Function(Pointer<Utf8>),
      bool Function(
          Pointer<Utf8>)>('stelnet_asr_kokoro_lang_has_native_voice_abi');
  final p = lang.toNativeUtf8();
  try {
    return fn(p);
  } finally {
...
String? kokoroResolveModelForLang(String modelPath, String lang,
    {String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_kokoro_resolve_model_for_lang_abi')) {
    return null;
  }
  final fn = lib.lookupFunction<
      Int32 Function(Pointer<Utf8>, Pointer<Utf8>, Pointer<Utf8>, Int32),
      int Function(Pointer<Utf8>, Pointer<Utf8>, Pointer<Utf8>,
          int)>('stelnet_asr_kokoro_resolve_model_for_lang_abi');
  final mp = modelPath.toNativeUtf8();
...
({String voicePath, String voiceName})? kokoroResolveFallbackVoice(
    ...
    {String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_kokoro_resolve_fallback_voice_abi')) {
    return null;
  }
  final fn = lib.lookupFunction<
      Int32 Function(Pointer<Utf8>, Pointer<Utf8>, Pointer<Utf8>, Int32,
      ...
      int Function(Pointer<Utf8>, Pointer<Utf8>, Pointer<Utf8>, int,
          Pointer<Utf8>, int)>('stelnet_asr_kokoro_resolve_fallback_voice_abi');
  final mp = modelPath.toNativeUtf8();
  final lp = lang.toNativeUtf8();
  const cap = 512;
...
// =========================================================================
// Audio watermark — StelnetASR native spread-spectrum + optional AudioSeal
// =========================================================================

/// Native audio watermarking via StelnetASR's `stelnet_asr_watermark_*` C API.
///
/// Provides two tiers:
...
class StelnetAsrWatermark {
  StelnetAsrWatermark._();

  /// Check whether the loaded dylib exports the watermark symbols.
  /// Returns false on older StelnetASR builds that predate the watermark API.
  static bool isAvailable({DynamicLibrary? lib}) {
    lib ??= DynamicLibrary.open(StelnetASR.defaultLibName());
    return lib.providesSymbol('stelnet_asr_watermark_embed') &&
        lib.providesSymbol('stelnet_asr_watermark_detect');
  }
  ...
  static bool loadModel(String ggufPath, {DynamicLibrary? lib}) {
    lib ??= DynamicLibrary.open(StelnetASR.defaultLibName());
    if (!lib.providesSymbol('stelnet_asr_watermark_load_model')) return false;
    final fn = lib.lookupFunction<Int32 Function(Pointer<Utf8>),
        int Function(Pointer<Utf8>)>('stelnet_asr_watermark_load_model');
  ...
  static Float32List embed(Float32List pcm,
    ...
    final fn = lib.lookupFunction<Void Function(Pointer<Float>, Int32, Float),
        void Function(Pointer<Float>, int, double)>('stelnet_asr_watermark_embed');
  ...
  static double detect(Float32List pcm, {DynamicLibrary? lib}) {
    ...
    final fn = lib.lookupFunction<Float Function(Pointer<Float>, Int32),
        double Function(Pointer<Float>, int)>('stelnet_asr_watermark_detect');
    final ptr = malloc<Float>(pcm.length);
    ptr.asTypedList(pcm.length).setAll(0, pcm);
...
///
/// Wraps the native `stelnet_asr_c2pa_sign()` / `stelnet_asr_pcm_to_wav()` C-ABI.
...
class StelnetAsrC2pa {
  ...
  static Uint8List? sign(
    ...
    lib ??= DynamicLibrary.open(StelnetASR.defaultLibName());
    if (!lib.providesSymbol('stelnet_asr_c2pa_sign')) return null;
    ...
    final signFn = lib.lookupFunction<
        ...
        Pointer<Uint8> Function(
            ...
            Pointer<Utf8>,
            Pointer<Utf8>,
            Pointer<IntPtr>)>('stelnet_asr_c2pa_sign');

    final freeFn = lib.lookupFunction<Void Function(Pointer<Uint8>),
        void Function(Pointer<Uint8>)>('stelnet_asr_c2pa_free');
  ...
  static Uint8List? pcmToWav(
    ...
    lib ??= DynamicLibrary.open(StelnetASR.defaultLibName());
    if (!lib.providesSymbol('stelnet_asr_pcm_to_wav')) return null;

    final fn = lib.lookupFunction<
        Pointer<Uint8> Function(Pointer<Float>, Int32, Int32, Pointer<IntPtr>),
        Pointer<Uint8> Function(
            Pointer<Float>, int, int, Pointer<IntPtr>)>('stelnet_asr_pcm_to_wav');
...
/// Parakeet chunked long-form windows ([StelnetAsrSession.transcribeChunked]) —
/// so no function pointers are needed on the Dart side.
int getTranscriptionProgress({String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_get_progress')) return -1;
  final fn = lib.lookupFunction<Int32 Function(), int Function()>(
      'stelnet_asr_get_progress');
  return fn();
}
...
void resetTranscriptionProgress({String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_reset_progress')) return;
  final fn = lib.lookupFunction<Void Function(), void Function()>(
      'stelnet_asr_reset_progress');
  fn();
}
...
int getStreamedSegmentCount({String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_get_streamed_segment_count')) return 0;
  final fn = lib.lookupFunction<Int32 Function(), int Function()>(
      'stelnet_asr_get_streamed_segment_count');
  return fn();
}
...
List<SessionSegment> drainStreamedSegments({String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_drain_streamed_segments')) return const [];
  final drain =
      lib.lookupFunction<Pointer<Void> Function(), Pointer<Void> Function()>(
          'stelnet_asr_drain_streamed_segments');
  final res = drain();
  if (res == nullptr) return const [];

  // Read segments using the same accessors as StelnetAsrSession._readSegments.
  ...
  final segNSPFn =
      lib.providesSymbol('stelnet_asr_session_result_segment_no_speech_prob')
          ? lib.lookupFunction<
              Float Function(Pointer<Void>, Int32),
              double Function(Pointer<Void>,
                  int)>('stelnet_asr_session_result_segment_no_speech_prob')
  ...
  // #300: native per-segment speaker label; probe like the others so a
  // newer package keeps working against an older dylib.
  final segSpkFn = lib.providesSymbol('stelnet_asr_session_result_segment_speaker')
      ? lib.lookupFunction<
          Pointer<Utf8> Function(Pointer<Void>, Int32),
          Pointer<Utf8> Function(
              Pointer<Void>, int)>('stelnet_asr_session_result_segment_speaker')
...
void resetStreamedSegments({String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_reset_streamed_segments')) return;
  final fn = lib.lookupFunction<Void Function(), void Function()>(
      'stelnet_asr_reset_streamed_segments');
  fn();
}
...
int getStreamedTokenCount({String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_get_streamed_token_count')) return 0;
  final fn = lib.lookupFunction<Int32 Function(), int Function()>(
      'stelnet_asr_get_streamed_token_count');
  return fn();
}
...
List<String> drainStreamedTokens({String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_drain_streamed_tokens')) return const [];
  final countPtr = calloc<Int32>();
  try {
    final fn = lib.lookupFunction<
        Pointer<Utf8> Function(Pointer<Int32>),
        Pointer<Utf8> Function(
            Pointer<Int32>)>('stelnet_asr_drain_streamed_tokens');
...
void resetStreamedTokens({String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_reset_streamed_tokens')) return;
  final fn = lib.lookupFunction<Void Function(), void Function()>(
      'stelnet_asr_reset_streamed_tokens');
  fn();
}
...
class DecodedAudioStereo {
  ...
  /// Sample rate (always 16000 for StelnetASR).
  final int sampleRate;
...
DecodedAudioStereo decodeAudioFileStereo(String path, {String? libPath}) {
  final lib = DynamicLibrary.open(libPath ?? StelnetASR.defaultLibName());
  if (!lib.providesSymbol('stelnet_asr_audio_load_stereo')) {
  ...
  final load = lib.lookupFunction<
      ...
      int Function(
          ...
          Pointer<Int32>,
          Pointer<Int32>,
          Pointer<Int32>)>('stelnet_asr_audio_load_stereo');
  final free = lib.lookupFunction<Void Function(Pointer<Float>),
      void Function(Pointer<Float>)>('stelnet_asr_audio_free');
  ...
  try {
    ...
    if (rc != 0) {
      throw Exception('stelnet_asr_audio_load_stereo failed (code $rc) for $path');
    }
    final n = nOut.value;
    final sr = srOut.value;
