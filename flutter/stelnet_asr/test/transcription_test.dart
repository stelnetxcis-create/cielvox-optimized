...
//
// Requires STELNET_ASR_LIB pointing at the built libwhisper and model files:
//   STELNET_ASR_LIB=../../../build-shared/src/libwhisper.so \
//   STELNET_ASR_MODEL=../../../models/ggml-tiny.en.bin \
...
void main() {
  ...
  test('session open + transcribe whisper-tiny', () {
    final modelPath = Platform.environment['STELNET_ASR_MODEL'] ??
    ...
    final openFn = lib.lookupFunction<Pointer Function(Pointer<Utf8>, Int32),
        Pointer Function(Pointer<Utf8>, int)>('stelnet_asr_session_open');
    final closeFn =
    ...
    final backendFn = lib.lookupFunction<Pointer<Utf8> Function(Pointer),
        Pointer<Utf8> Function(Pointer)>('stelnet_asr_session_backend');
    final transcribeFn = lib.lookupFunction<
        Pointer Function(Pointer, Pointer<Float>, Int32),
        Pointer Function(
            Pointer, Pointer<Float>, int)>('stelnet_asr_session_transcribe');
    final nSegFn =
    ...
    final segTextFn = lib.lookupFunction<
        ...
        Pointer<Utf8> Function(
            Pointer, int)>('stelnet_asr_session_result_segment_text');
    final segT0Fn = lib.lookupFunction<Int64 Function(Pointer, Int32),
        int Function(Pointer, int)>('stelnet_asr_session_result_segment_t0');
    final segT1Fn = lib.lookupFunction<Int64 Function(Pointer, Int32),
        int Function(Pointer, int)>('stelnet_asr_session_result_segment_t1');
    final resultFreeFn =
        lib.lookupFunction<Void Function(Pointer), void Function(Pointer)>(
