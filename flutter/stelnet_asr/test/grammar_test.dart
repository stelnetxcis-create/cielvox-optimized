// Tests for StelnetAsrSession.setGrammar — GBNF parser + symbol-
// resolution path. Requires STELNET_ASR_LIB + STELNET_ASR_MODEL like
...
void main() {
  ...
  group('StelnetAsrSession.setGrammar', () {
