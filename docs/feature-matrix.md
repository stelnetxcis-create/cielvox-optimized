...
<!-- Source of truth: `stelnettts --list-backends-json`. -->

# Feature matrix

All 106 backends compiled into the `stelnettts` binary, with their declared capability bits. For an interactive sortable/filterable view, open [`feature-matrix.html`](https://htmlpreview.github.io/?https://github.com/Cyna/StelnetTTS/blob/main/docs/feature-matrix.html).
