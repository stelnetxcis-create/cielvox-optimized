...
enum {
    STELNETTTS_ESPEAK_AUDIO_OUTPUT_SYNCHRONOUS = 0x02,
    STELNETTTS_ESPEAK_INITIALIZE_PHONEME_IPA = 0x0002,
    STELNETTTS_ESPEAK_INITIALIZE_DONT_EXIT = 0x8000,
    STELNETTTS_ESPEAK_CHARS_UTF8 = 1,
};
