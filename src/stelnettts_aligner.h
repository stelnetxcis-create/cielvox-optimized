// stelnettts_aligner.h — shared CTC / forced-alignment helper.
//
...
//
//   * cielvox2-forced-aligner Qwen/Qwen3-ForcedAligner-0.6B. Same Qwen3-ASR
//                          architecture as the regular cielvox2-asr backend
...
//
// Shared by the CLI, the C-ABI wrapper `stelnettts_align_words_abi` in
// stelnettts_c_api.cpp, and every language binding that reaches through
// that wrapper. `stelnettts_word_aligned` is an in-library POD; the CLI
// adapts it to its own `stelnettts_word` type.
