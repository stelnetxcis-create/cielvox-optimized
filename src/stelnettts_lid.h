// stelnettts_lid.h — shared language identification helpers.
//
...
//
// Shared by the CLI, the C-ABI wrapper `stelnettts_detect_language_pcm`
// in stelnettts_c_api.cpp, and every language binding that calls through
// that wrapper.
