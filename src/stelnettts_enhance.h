// stelnettts_enhance.h — audio-enhancement helpers.
//
...
// `stelnettts_enhance_audio_rnnoise` in stelnettts_c_api.cpp. Same
// "consume PCM → produce PCM" layering as stelnettts_lid.{h,cpp}.
