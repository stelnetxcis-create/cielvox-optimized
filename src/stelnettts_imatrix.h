// stelnettts_imatrix.h — importance-matrix (activation-statistics) collector.
//
// When the environment variable STELNETTTS_IMATRIX_OUT is set to a file path,
...
// output file.
//
// The resulting file is consumed by `stelnettts-quantize --imatrix <file>`,
...
//
// This is a no-op unless STELNETTTS_IMATRIX_OUT is set; production paths are
// unaffected. Ported from StelnetEmbed src/imatrix.cpp.
...
// STELNETTTS_IMATRIX_OUT is unset. Call once, right after ggml_backend_sched_new.
