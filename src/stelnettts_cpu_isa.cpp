// stelnettts_cpu_isa.cpp — see stelnettts_cpu_isa.h for rationale (#261).

#include "stelnettts_cpu_isa.h"
...
namespace stelnettts_cpu_isa {

#if STELNETTTS_ISA_X86
...
IsaCheck check() {
    ...
    //      CMake picks independently of the flags used for StelnetTTS's sources.
    //
    ...
    // inside libggml-cpu's ggml_cpu_init(). A baseline-built stelnettts_cpu_isa.cpp
