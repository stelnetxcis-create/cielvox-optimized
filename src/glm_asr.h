...
// the session API's stelnettts_session_set_beam_size — PLAN §90. The
...
// #292: forward --max-new-tokens. <= 0 keeps the backend default.
void glm_asr_set_max_new_tokens(struct glm_asr_context* ctx, int n);
