// stelnettts_speaker_cluster.cpp — agglomerative single-linkage cosine
...
std::vector<int> stelnettts_agglomerative_cluster(const std::vector<float>& embeddings, int n, int dim,
