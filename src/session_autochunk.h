...
//   enabled          — STELNETTTS_SESSION_AUTOCHUNK (default on)
//   backend          — session backend id
//   n_samples, sr    — buffer length
//   chunk_seconds    — window (STELNETTTS_SESSION_CHUNK_SECONDS, default 30)
...
// pin one via STELNETTTS_SESSION_CHUNK_SECONDS. The shipped default is a flat 30 s
...
//
// F4 (opt-in via STELNETTTS_SESSION_PERBACKEND_CHUNK=1): short-segment models whose
...
// STELNETTTS_SESSION_CHUNK_SECONDS remains the direct per-call override for any run.
