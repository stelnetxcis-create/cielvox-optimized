...
huggingface-cli download Xenna/parakeet-ctc-1.1b-ja-GGUF \
...
> **Backend:** this is a **CTC** model — let stelnettts auto-detect it (as
...
```bash
./build/bin/stelnettts -m parakeet-ctc-1.1b-ja \
...
```bash
./build/bin/stelnettts -m parakeet-ctc-1.1b-ja-q8_0.gguf \
