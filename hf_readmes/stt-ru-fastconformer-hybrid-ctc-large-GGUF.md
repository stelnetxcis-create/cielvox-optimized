---
license: cc-by-4.0
base_model: nvidia/stt_ru_fastconformer_hybrid_large_pc
language:
  - ru
tags:
...
```bash
# Russian ASR:
stelnettts --backend fastconformer-ctc -m stt-ru-fastconformer-hybrid-ctc-large-q4_k.gguf -f audio.wav

# Forced alignment (word timestamps for known text, or re-timing an .srt):
stelnettts --align-only -am stt-ru-fastconformer-hybrid-ctc-large-q4_k.gguf \
