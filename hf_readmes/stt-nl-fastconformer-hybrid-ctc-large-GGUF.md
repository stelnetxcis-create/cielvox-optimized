---
license: cc-by-4.0
base_model: nvidia/stt_nl_fastconformer_hybrid_large_pc
language:
  - nl
tags:
...
```bash
# Dutch ASR:
stelnettts --backend fastconformer-ctc -m stt-nl-fastconformer-hybrid-ctc-large-q4_k.gguf -f audio.wav

# Forced alignment (word timestamps for known text, or re-timing an .srt):
stelnettts --align-only -am stt-nl-fastconformer-hybrid-ctc-large-q4_k.gguf \
