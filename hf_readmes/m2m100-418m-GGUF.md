...
GGUF / ggml conversion of [`facebook/m2m100_418M`](https://huggingface.co/facebook/m2m100_418M) for use with **[Cyna/StelnetTTS](https://github.com/Cyna/StelnetTTS)**.
...
# 2. Pull model
huggingface-cli download Xenna/m2m100-418m-GGUF m2m100-418m-q8_0.gguf --local-dir .

# 3. Translate (standalone)
./build/bin/stelnettts --backend m2m100 -m m2m100-418m-q8_0.gguf \
...
# Auto-download (registered in src/stelnettts_model_registry.cpp):
