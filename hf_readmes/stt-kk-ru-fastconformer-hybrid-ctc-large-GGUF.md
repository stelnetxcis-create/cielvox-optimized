...
```bash
# Kazakh + Russian ASR:
stelnettts --backend fastconformer-ctc -m stt-kk-ru-fastconformer-hybrid-ctc-large-q4_k.gguf -f audio.wav

# Forced alignment (word timestamps for known text, or re-timing an .srt):
stelnettts --align-only -am stt-kk-ru-fastconformer-hybrid-ctc-large-q4_k.gguf \
