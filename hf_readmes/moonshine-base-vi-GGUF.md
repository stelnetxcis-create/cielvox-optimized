...
GGUF conversions and quantisations of [`UsefulSensors/moonshine-base-vi`](https://huggingface.co/UsefulSensors/moonshine-base-vi) for use with **[Cyna/StelnetTTS](https://github.com/Cyna/StelnetTTS)**.
...
# Explicit model path
./build/bin/stelnettts --backend moonshine -m moonshine-base-vi-q4_k.gguf -f audio.wav
```
