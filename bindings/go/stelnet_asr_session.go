...
// StelnetASR Session API for TTS-capable backends (kokoro, vibevoice,
...
// src/stelnet_asr_c_api.cpp (Session) and src/kokoro.h
// (kokoro_resolve_*_abi). They're exported by libstelnet_asr.dylib /
// .so and linked in via cgo's -lstelnet_asr.

typedef struct StelnetAsrSession StelnetAsrSession;

StelnetAsrSession* stelnet_asr_session_open(const char* model_path, int n_threads);
void             stelnet_asr_session_close(StelnetAsrSession* s);
int              stelnet_asr_session_set_codec_path(StelnetAsrSession* s, const char* path);
int              stelnet_asr_session_set_source_language(StelnetAsrSession* s, const char* lang);
int              stelnet_asr_session_set_target_language(StelnetAsrSession* s, const char* lang);
int              stelnet_asr_session_set_tts_reference_language(StelnetAsrSession* s, const char* lang);
int              stelnet_asr_session_set_punctuation(StelnetAsrSession* s, int enable);
int              stelnet_asr_session_set_punc_model(StelnetAsrSession* s, const char* punc_model);
int              stelnet_asr_session_set_hotwords(StelnetAsrSession* s, const char* hotwords, float boost);
// Source separation (#359): stereo interleaved PCM in at the model's own rate.
int              stelnet_asr_session_separate(StelnetAsrSession* s, const float* pcm_stereo, int n_samples);
int              stelnet_asr_session_separate_n_stems(StelnetAsrSession* s);
const char*      stelnet_asr_session_separate_stem_name(StelnetAsrSession* s, int stem_idx);
const float*     stelnet_asr_session_separate_stem(StelnetAsrSession* s, int stem_idx, int* out_n_samples);
int              stelnet_asr_session_separate_sample_rate(StelnetAsrSession* s);
int              stelnet_asr_session_input_sample_rate(StelnetAsrSession* s);
int              stelnet_asr_session_output_sample_rate(StelnetAsrSession* s);
int              stelnet_asr_session_set_sensitivity(StelnetAsrSession* s, const char* preset);
int              stelnet_asr_session_set_translate(StelnetAsrSession* s, int enable);
int              stelnet_asr_session_set_temperature(StelnetAsrSession* s, float temperature, unsigned long long seed);
int              stelnet_asr_session_set_tts_seed(StelnetAsrSession* s, unsigned long long seed);
int              stelnet_asr_session_set_max_new_tokens(StelnetAsrSession* s, int max_new_tokens);
int              stelnet_asr_session_set_frequency_penalty(StelnetAsrSession* s, float penalty);
int              stelnet_asr_session_set_tts_steps(StelnetAsrSession* s, int steps);
int              stelnet_asr_session_set_tts_num_candidates(StelnetAsrSession* s, int n);
int              stelnet_asr_session_set_top_p(StelnetAsrSession* s, float top_p);
int              stelnet_asr_session_set_top_k(StelnetAsrSession* s, int top_k);
int              stelnet_asr_session_set_do_sample(StelnetAsrSession* s, int enable);
int              stelnet_asr_session_set_min_p(StelnetAsrSession* s, float min_p);
int              stelnet_asr_session_set_repetition_penalty(StelnetAsrSession* s, float r);
int              stelnet_asr_session_set_cfg_weight(StelnetAsrSession* s, float cfg_weight);
int              stelnet_asr_session_set_tts_noise_temp(StelnetAsrSession* s, float noise_temp);
int              stelnet_asr_session_set_exaggeration(StelnetAsrSession* s, float exaggeration);
int              stelnet_asr_session_set_max_speech_tokens(StelnetAsrSession* s, int n);
int              stelnet_asr_session_set_min_speech_tokens(StelnetAsrSession* s, int n);
int              stelnet_asr_session_set_length_scale(StelnetAsrSession* s, float scale);
int              stelnet_asr_session_set_g2p_dict(StelnetAsrSession* s, const char* source);
int              stelnet_asr_session_set_best_of(StelnetAsrSession* s, int n);
int              stelnet_asr_session_set_beam_size(StelnetAsrSession* s, int n);
int              stelnet_asr_session_set_return_logits(StelnetAsrSession* s, int enable);
int              stelnet_asr_session_set_grammar_text(StelnetAsrSession* s, const char* gbnf_text,
                                                   const char* root_rule, float penalty);
int              stelnet_asr_session_set_fallback_thresholds(StelnetAsrSession* s, float entropy_thold,
                                                          float logprob_thold, float no_speech_thold,
                                                          float temperature_inc);
int              stelnet_asr_session_set_alt_n(StelnetAsrSession* s, int n);
int              stelnet_asr_session_set_whisper_decode_extras(StelnetAsrSession* s, int suppress_nst,
                                                            const char* suppress_regex,
                                                            int carry_initial_prompt);
int              stelnet_asr_session_set_ask(StelnetAsrSession* s, const char* prompt);
int              stelnet_asr_session_detect_language(StelnetAsrSession* s, const float* pcm, int n_samples,
                                                  const char* lid_model_path, int method,
                                                  char* out_lang, int out_lang_cap, float* out_prob);
int              stelnet_asr_session_set_voice(StelnetAsrSession* s, const char* path, const char* ref_text_or_null);
int              stelnet_asr_session_set_speaker_name(StelnetAsrSession* s, const char* name);
int              stelnet_asr_session_set_speaker_id(StelnetAsrSession* s, int id);
int              stelnet_asr_session_n_speakers(StelnetAsrSession* s);
const char*      stelnet_asr_session_get_speaker_name(StelnetAsrSession* s, int i);
int              stelnet_asr_session_set_instruct(StelnetAsrSession* s, const char* instruct);
int              stelnet_asr_session_set_tts_phonemes(StelnetAsrSession* s, const char* phonemes);
int              stelnet_asr_session_is_custom_voice(StelnetAsrSession* s);
int              stelnet_asr_session_is_voice_design(StelnetAsrSession* s);
float*           stelnet_asr_session_synthesize(StelnetAsrSession* s, const char* text, int* out_n_samples);
float*           stelnet_asr_session_synthesize_raw(StelnetAsrSession* s, const char* text, int* out_n_samples);
int              stelnet_asr_session_accept_marking_responsibility(StelnetAsrSession* s, const char* attestation);
int              stelnet_asr_session_set_speaker_identity(StelnetAsrSession* s, const char* identity);
float*           stelnet_asr_session_speech_to_speech(StelnetAsrSession* s, const float* in_samples, int n_in_samples,
                                                    char** out_text, int* out_n_samples);
void             stelnet_asr_session_translate_text_free(char* text);
void             stelnet_asr_pcm_free(float* pcm);
int              stelnet_asr_session_kokoro_clear_phoneme_cache(StelnetAsrSession* s);

int stelnet_asr_kokoro_resolve_model_for_lang_abi(const char* model_path, const char* lang,
                                               char* out_path, int out_path_len);
int stelnet_asr_kokoro_resolve_fallback_voice_abi(const char* model_path, const char* lang,
                                               char* out_path, int out_path_len,
                                               char* out_picked, int out_picked_len);

// --- ASR transcription (PLAN #59) ---
typedef struct stelnet_asr_session_result stelnet_asr_session_result;
stelnet_asr_session_result* stelnet_asr_session_transcribe(StelnetAsrSession* s, const float* pcm, int n_samples);
stelnet_asr_session_result* stelnet_asr_session_transcribe_lang(StelnetAsrSession* s, const float* pcm, int n_samples,
                                                          const char* language);
stelnet_asr_session_result* stelnet_asr_session_transcribe_chunked_lang(StelnetAsrSession* s, const float* pcm, int n_samples,
                                                                  int chunk_seconds, int overlap_seconds,
                                                                  const char* language);
stelnet_asr_session_result* stelnet_asr_session_transcribe_vad(StelnetAsrSession* s, const float* pcm, int n_samples,
                                                         int sample_rate, const char* vad_model_path, void* opts);
int          stelnet_asr_get_progress(void);
int          stelnet_asr_session_result_n_segments(stelnet_asr_session_result* r);
const char*  stelnet_asr_session_result_segment_text(stelnet_asr_session_result* r, int i);
long long    stelnet_asr_session_result_segment_t0(stelnet_asr_session_result* r, int i);
long long    stelnet_asr_session_result_segment_t1(stelnet_asr_session_result* r, int i);
int          stelnet_asr_session_result_n_words(stelnet_asr_session_result* r, int i_seg);
const char*  stelnet_asr_session_result_word_text(stelnet_asr_session_result* r, int i_seg, int i_word);
long long    stelnet_asr_session_result_word_t0(stelnet_asr_session_result* r, int i_seg, int i_word);
long long    stelnet_asr_session_result_word_t1(stelnet_asr_session_result* r, int i_seg, int i_word);
float        stelnet_asr_session_result_word_p(stelnet_asr_session_result* r, int i_seg, int i_word);
float        stelnet_asr_session_result_segment_no_speech_prob(stelnet_asr_session_result* r, int i_seg);
const char*  stelnet_asr_session_result_segment_speaker(stelnet_asr_session_result* r, int i);
// Per-frame CTC logits (opted in via stelnet_asr_session_set_return_logits) for
...
// none captured.
int          stelnet_asr_session_result_n_logit_frames(stelnet_asr_session_result* r);
int          stelnet_asr_session_result_n_logit_vocab(stelnet_asr_session_result* r);
const float* stelnet_asr_session_result_logits(stelnet_asr_session_result* r);
void         stelnet_asr_session_result_free(stelnet_asr_session_result* r);

// --- Punctuation (PLAN #59) ---
void*        stelnet_asr_punc_init(const char* model_path);
const char*  stelnet_asr_punc_process(void* ctx, const char* text);
void         stelnet_asr_punc_free_text(const char* text);
void         stelnet_asr_punc_free(void* ctx);

// --- Alignment (PLAN #59) ---
typedef struct stelnet_asr_align_result stelnet_asr_align_result;
stelnet_asr_align_result* stelnet_asr_align_words_abi(const char* aligner_model, const char* transcript,
                                                 const float* samples, int n_samples, long long t_offset_cs,
                                                 int n_threads);
int          stelnet_asr_align_result_n_words(stelnet_asr_align_result* r);
const char*  stelnet_asr_align_result_word_text(stelnet_asr_align_result* r, int i);
long long    stelnet_asr_align_result_word_t0(stelnet_asr_align_result* r, int i);
long long    stelnet_asr_align_result_word_t1(stelnet_asr_align_result* r, int i);
void         stelnet_asr_align_result_free(stelnet_asr_align_result* r);

// --- Watermark ---
int   stelnet_asr_watermark_load_model(const char* gguf_path);
void  stelnet_asr_watermark_embed(float* pcm, int n_samples, float alpha);
float stelnet_asr_watermark_detect(const float* pcm, int n_samples);

// --- VAD (PLAN #59) ---
int stelnet_asr_vad_segments(const char* vad_model_path, const float* pcm, int n_samples,
                          int sample_rate, float threshold, int min_speech_ms, int min_silence_ms,
                          int n_threads, int use_gpu, float** out_spans);
void stelnet_asr_vad_free(float* spans);

// --- Diarization (PLAN #59) ---
struct stelnet_asr_diarize_seg_abi {
    long long t0_cs;
    long long t1_cs;
    int       speaker;
    int       _pad;
};
struct stelnet_asr_diarize_opts_abi {
    int         method;
    int         n_threads;
    long long   slice_t0_cs;
    const char* pyannote_model_path;
    // #324 foxnose (method 4). This layout is hand-maintained and MUST match
    // struct stelnet_asr_diarize_opts_abi in src/stelnet_asr_c_api.cpp exactly —
...
int stelnet_asr_diarize_segments_abi(const float* left_pcm, const float* right_pcm, int n_samples,
                                  int is_stereo, struct stelnet_asr_diarize_seg_abi* segs, int n_segs,
                                  const struct stelnet_asr_diarize_opts_abi* opts);

// --- Pluggable speaker embedder, clustering, pyannote cache (#107 P6) ---
void*       stelnet_asr_speaker_embedder_make_abi(const char* model_spec, int n_threads, const char* cache_dir);
void        stelnet_asr_speaker_embedder_free_abi(void* embedder);
int         stelnet_asr_speaker_embedder_dim_abi(const void* embedder);
int         stelnet_asr_speaker_embedder_embed_abi(void* embedder, const float* pcm_16k, int n_samples, float* out);
const char* stelnet_asr_speaker_embedder_name_abi(const void* embedder);
int         stelnet_asr_speaker_cluster_abi(const float* embeddings, int n, int dim,
                                         float merge_threshold, int max_speakers, int* labels_out);
void*       stelnet_asr_pyannote_cache_compute_abi(const float* full_audio, int n_samples,
                                                const char* model_path, int n_threads);
void        stelnet_asr_pyannote_cache_free_abi(void* cache);
int         stelnet_asr_pyannote_cache_apply_abi(const void* cache, long long slice_t0_cs,
                                              struct stelnet_asr_diarize_seg_abi* segs, int n_segs);

// --- Standalone LID (PLAN #59) ---
int stelnet_asr_detect_language_pcm(const float* samples, int n_samples, int method,
                                  const char* model_path, int n_threads, int use_gpu,
                                  int gpu_device, int flash_attn,
                                  char* out_lang, int out_lang_cap, float* out_prob);

// --- Registry + cache (PLAN #59) ---
int stelnet_asr_registry_lookup_abi(const char* backend, char* out_filename, int filename_cap,
                                 char* out_url, int url_cap, char* out_size, int size_cap);
int stelnet_asr_cache_ensure_file_abi(const char* filename, const char* url, int quiet,
                                   const char* cache_dir_override, char* out_buf, int out_cap);
int stelnet_asr_cache_dir_abi(const char* cache_dir_override, char* out_buf, int out_cap);

// --- Streaming (PLAN #62) ---
typedef struct StelnetAsrStream StelnetAsrStream;
StelnetAsrStream* stelnet_asr_session_stream_open(StelnetAsrSession* s, int n_threads, int step_ms,
                                             int length_ms, int keep_ms, const char* language, int translate);
StelnetAsrStream* stelnet_asr_stream_open(void* ctx, int n_threads, int step_ms,
                                     int length_ms, int keep_ms, const char* language, int translate);
int             stelnet_asr_stream_feed(StelnetAsrStream* s, const float* pcm, int n_samples);
int             stelnet_asr_stream_get_text(StelnetAsrStream* s, char* out_text, int out_cap,
                                         double* out_t0_s, double* out_t1_s, long long* out_counter);
int             stelnet_asr_stream_flush(StelnetAsrStream* s);
void            stelnet_asr_stream_close(StelnetAsrStream* s);
void            stelnet_asr_stream_set_live_decode(StelnetAsrStream* s, int enabled);

// --- Text-LID ---
int stelnet_asr_text_detect_language(const char* text, const char* model_path, int n_threads,
                                  char* out_label, int out_label_cap, float* out_confidence);

// --- Backend detection ---
int stelnet_asr_detect_backend_from_gguf(const char* path, char* out_name, int out_cap);

// --- RNNoise audio enhancement ---
int stelnet_asr_enhance_audio_rnnoise(const float* in_pcm, int n_samples, float* out_pcm, int out_cap);

// --- params_set_* on whisper_full_params ---
void stelnet_asr_params_set_language(void* p, const char* lang);
void stelnet_asr_params_set_translate(void* p, int v);
void stelnet_asr_params_set_detect_language(void* p, int v);
void stelnet_asr_params_set_token_timestamps(void* p, int v);
void stelnet_asr_params_set_n_threads(void* p, int n);
void stelnet_asr_params_set_max_len(void* p, int n);
void stelnet_asr_params_set_best_of(void* p, int n);
void stelnet_asr_params_set_split_on_word(void* p, int v);
void stelnet_asr_params_set_no_context(void* p, int v);
void stelnet_asr_params_set_single_segment(void* p, int v);
void stelnet_asr_params_set_print_realtime(void* p, int v);
void stelnet_asr_params_set_print_progress(void* p, int v);
void stelnet_asr_params_set_print_timestamps(void* p, int v);
void stelnet_asr_params_set_print_special(void* p, int v);
void stelnet_asr_params_set_suppress_blank(void* p, int v);
void stelnet_asr_params_set_temperature(void* p, float t);
void stelnet_asr_params_set_max_tokens(void* p, int n);
void stelnet_asr_params_set_initial_prompt(void* p, const char* prompt);
void stelnet_asr_params_set_alt_n(void* p, int n);
void stelnet_asr_params_set_vad(void* p, int v);
void stelnet_asr_params_set_vad_model_path(void* p, const char* path);
void stelnet_asr_params_set_vad_threshold(void* p, float t);
void stelnet_asr_params_set_vad_min_speech_ms(void* p, int ms);
void stelnet_asr_params_set_vad_min_silence_ms(void* p, int ms);
void stelnet_asr_params_set_tdrz(void* p, int v);

// --- Token-level accessors ---
long long stelnet_asr_token_t0(void* ctx, int i_seg, int i_tok);
long long stelnet_asr_token_t1(void* ctx, int i_seg, int i_tok);
float     stelnet_asr_token_p(void* ctx, int i_seg, int i_tok);
int       stelnet_asr_token_n_alts(void* ctx, int i_seg, int i_tok);
int       stelnet_asr_token_alt_id(void* ctx, int i_seg, int i_tok, int i_alt);
float     stelnet_asr_token_alt_p(void* ctx, int i_seg, int i_tok, int i_alt);
int       stelnet_asr_token_alt_text(void* ctx, int i_seg, int i_tok, int i_alt, char* out, int out_cap);

// --- Language detection (whisper context) ---
float stelnet_asr_detect_language(void* ctx, const float* pcm, int n_samples,
                               int n_threads, char* out_code, int out_cap);

// --- VAD slices ---
int stelnet_asr_vad_slices(const char* vad_model_path, const float* pcm, int n_samples,
                        int sample_rate, float threshold, int min_speech_ms, int min_silence_ms,
                        int speech_pad_ms, float max_chunk_duration_s, int n_threads,
                        float** out_spans);

// --- LCS dedup ---
int stelnet_asr_lcs_dedup_prefix_count(const int* prev_tail_tokens, int n_prev,
...
void* stelnet_asr_parakeet_init(const char* model_path, int n_threads, int use_flash);
void  stelnet_asr_parakeet_free(void* ctx);
void* stelnet_asr_parakeet_transcribe(void* ctx, const float* pcm, int n_samples, const char* language);
const char* stelnet_asr_parakeet_result_text(void* r);
int         stelnet_asr_parakeet_result_n_words(void* r);
const char* stelnet_asr_parakeet_result_word_text(void* r, int i);
long long   stelnet_asr_parakeet_result_word_t0(void* r, int i);
long long   stelnet_asr_parakeet_result_word_t1(void* r, int i);
int         stelnet_asr_parakeet_result_n_tokens(void* r);
const char* stelnet_asr_parakeet_result_token_text(void* r, int i);
long long   stelnet_asr_parakeet_result_token_t0(void* r, int i);
long long   stelnet_asr_parakeet_result_token_t1(void* r, int i);
float       stelnet_asr_parakeet_result_token_p(void* r, int i);
void        stelnet_asr_parakeet_result_free(void* r);

// --- TitaNet ---
void* stelnet_asr_titanet_init(const char* model_path, int n_threads);
void  stelnet_asr_titanet_free(void* ctx);
int   stelnet_asr_titanet_embed(void* ctx, const float* pcm_16k, int n_samples, float* out);
float stelnet_asr_titanet_cosine_sim(const float* a, const float* b, int dim);

// --- Speaker database (closed-roster, consent-gated — issue #266) ---
void* stelnet_asr_speaker_db_open(const char* dir_path, const char* expected_names_csv,
                               int consent_attested);
void  stelnet_asr_speaker_db_free(void* db);
int   stelnet_asr_speaker_db_count(const void* db);
float stelnet_asr_speaker_db_match(const void* db, const float* embedding, int dim,
                                float threshold, char* out_name, int out_cap);
int   stelnet_asr_speaker_db_enroll2(const char* dir_path, const char* name,
                                  const float* embedding, int dim, int consent_attested);

// --- Kokoro lang helpers ---
int  stelnet_asr_kokoro_lang_is_german_abi(const char* lang);
int  stelnet_asr_kokoro_lang_has_native_voice_abi(const char* lang);

// --- Registry by filename ---
int stelnet_asr_registry_lookup_by_filename_abi(const char* filename, char* out_filename, int filename_cap,
                                             char* out_url, int url_cap, char* out_size, int size_cap);
int stelnet_asr_registry_list_backends_abi(char* out_csv, int out_cap);
int stelnet_asr_registry_default_bundle_info_abi(const char* backend, char* out_backend, int backend_cap,
                                              char* out_license, int license_cap, int* out_requires_acceptance);
int stelnet_asr_registry_default_bundle_artifact_abi(const char* backend, int index, int* out_kind,
                                                  char* out_filename, int filename_cap, char* out_url,
                                                  int url_cap, char* out_size, int size_cap);

// --- Session extras ---
int stelnet_asr_session_available_backends(char* out_csv, int out_cap);
int stelnet_asr_session_detected_language(StelnetAsrSession* s, char* out_buf, int out_cap);
...
int          stelnet_asr_session_n_vocab(StelnetAsrSession* s);
const char*  stelnet_asr_session_token_text(StelnetAsrSession* s, int id);
StelnetAsrSession* stelnet_asr_session_open_explicit(const char* model_path, const char* backend_name, int n_threads);
StelnetAsrSession* stelnet_asr_session_open_with_params(const char* model_path, const char* backend_name, const void* params);
stelnet_asr_session_result* stelnet_asr_session_transcribe_vad_lang(StelnetAsrSession* s, const float* pcm, int n_samples,
                                                              int sample_rate, const char* vad_model_path, void* opts,
                                                              const char* language);
char* stelnet_asr_session_translate_text(StelnetAsrSession* s, const char* text, const char* src_lang,
                                      const char* tgt_lang, int max_tokens);
void  stelnet_asr_session_translate_text_free(char* text);
int   stelnet_asr_session_result_word_n_alts(stelnet_asr_session_result* r, int i_seg, int i_word);
const char* stelnet_asr_session_result_word_alt_text(stelnet_asr_session_result* r, int i_seg, int i_word, int i_alt);
float stelnet_asr_session_result_word_alt_p(stelnet_asr_session_result* r, int i_seg, int i_word, int i_alt);
*/
import "C"
...
// StelnetAsrSession is a TTS/S2S-capable session (kokoro, vibevoice, qwen3-tts, moss-tts, orpheus, parler-tts, pocket-tts, tada, lfm2-audio, mini-omni2).
type StelnetAsrSession struct {
	handle *C.StelnetAsrSession
}
...
func SessionOpen(modelPath string, nThreads int) (*StelnetAsrSession, error) {
	cpath := C.CString(modelPath)
	defer C.free(unsafe.Pointer(cpath))
	h := C.stelnet_asr_session_open(cpath, C.int(nThreads))
	if h == nil {
		return nil, errors.New("stelnet_asr_session_open: failed to open " + modelPath)
	}
	return &StelnetAsrSession{handle: h}, nil
}

// Close releases the session handle.
func (s *StelnetAsrSession) Close() {
	if s != nil && s.handle != nil {
		C.stelnet_asr_session_close(s.handle)
		s.handle = nil
	}
}
...
func (s *StelnetAsrSession) ClearPhonemeCache() error {
	rc := C.stelnet_asr_session_kokoro_clear_phoneme_cache(s.handle)
	if rc != 0 {
		return errors.New("stelnet_asr_session_kokoro_clear_phoneme_cache failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetSourceLanguage(lang string) error {
	cl := C.CString(lang)
	defer C.free(unsafe.Pointer(cl))
	rc := C.stelnet_asr_session_set_source_language(s.handle, cl)
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_source_language failed")
	}
	return nil
}
...
// SetTranslate(true).
func (s *StelnetAsrSession) SetTargetLanguage(lang string) error {
	cl := C.CString(lang)
	defer C.free(unsafe.Pointer(cl))
	rc := C.stelnet_asr_session_set_target_language(s.handle, cl)
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_target_language failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetTTSReferenceLanguage(lang string) error {
	cl := C.CString(lang)
	defer C.free(unsafe.Pointer(cl))
	rc := C.stelnet_asr_session_set_tts_reference_language(s.handle, cl)
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_tts_reference_language failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetPunctuation(enable bool) error {
	v := C.int(0)
	if enable {
		v = 1
	}
	rc := C.stelnet_asr_session_set_punctuation(s.handle, v)
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_punctuation failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetPuncModel(model string) error {
	cm := C.CString(model)
	defer C.free(unsafe.Pointer(cm))
	rc := C.stelnet_asr_session_set_punc_model(s.handle, cm)
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_punc_model failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetHotwords(hotwords string, boost float32) error {
	ch := C.CString(hotwords)
	defer C.free(unsafe.Pointer(ch))
	rc := C.stelnet_asr_session_set_hotwords(s.handle, ch, C.float(boost))
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_hotwords failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetSensitivity(preset string) error {
	cp := C.CString(preset)
	defer C.free(unsafe.Pointer(cp))
	rc := C.stelnet_asr_session_set_sensitivity(s.handle, cp)
	if rc == -2 {
		return errors.New("unknown sensitivity preset (expected: conservative, balanced, aggressive)")
	}
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_sensitivity failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetTranslate(enable bool) error {
	v := C.int(0)
	if enable {
		v = 1
	}
	rc := C.stelnet_asr_session_set_translate(s.handle, v)
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_translate failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetTemperature(temperature float32, seed uint64) error {
	rc := C.stelnet_asr_session_set_temperature(s.handle, C.float(temperature), C.ulonglong(seed))
	// rc == -2 means no backend in this session honours it — soft no-op.
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_temperature failed")
	}
	return nil
}
...
// silently no-op.
func (s *StelnetAsrSession) SetTTSSeed(seed uint64) error {
	rc := C.stelnet_asr_session_set_tts_seed(s.handle, C.ulonglong(seed))
	// rc == -2 means no backend in this session honours it — soft no-op.
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_tts_seed failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetMaxNewTokens(maxNewTokens int) error {
	rc := C.stelnet_asr_session_set_max_new_tokens(s.handle, C.int(maxNewTokens))
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_max_new_tokens failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetFrequencyPenalty(penalty float32) error {
	rc := C.stelnet_asr_session_set_frequency_penalty(s.handle, C.float(penalty))
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_frequency_penalty failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetTTSSteps(steps int) error {
	rc := C.stelnet_asr_session_set_tts_steps(s.handle, C.int(steps))
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_tts_steps failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetTTSNumCandidates(n int) error {
	rc := C.stelnet_asr_session_set_tts_num_candidates(s.handle, C.int(n))
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_tts_num_candidates failed")
	}
	return nil
}

// SetTopP sets the top-p nucleus-sampling threshold. Honoured by chatterbox.
func (s *StelnetAsrSession) SetTopP(topP float32) error {
	rc := C.stelnet_asr_session_set_top_p(s.handle, C.float(topP))
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_top_p failed")
	}
	return nil
}

// SetTopK sets the top-k sampling cutoff (0 = disabled). Honoured by TADA.
func (s *StelnetAsrSession) SetTopK(topK int) error {
	rc := C.stelnet_asr_session_set_top_k(s.handle, C.int(topK))
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_top_k failed")
	}
	return nil
}

// SetDoSample enables/disables sampling (false = greedy). Honoured by TADA.
func (s *StelnetAsrSession) SetDoSample(enable bool) error {
	cEnable := C.int(0)
	if enable {
		cEnable = C.int(1)
	}
	rc := C.stelnet_asr_session_set_do_sample(s.handle, cEnable)
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_do_sample failed")
	}
	return nil
}

// SetMinP sets the min-p sampling threshold. Honoured by chatterbox.
func (s *StelnetAsrSession) SetMinP(minP float32) error {
	rc := C.stelnet_asr_session_set_min_p(s.handle, C.float(minP))
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_min_p failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetRepetitionPenalty(r float32) error {
	rc := C.stelnet_asr_session_set_repetition_penalty(s.handle, C.float(r))
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_repetition_penalty failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetCFGWeight(cfgWeight float32) error {
	rc := C.stelnet_asr_session_set_cfg_weight(s.handle, C.float(cfgWeight))
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_cfg_weight failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetTtsNoiseTemp(noiseTemp float32) error {
	rc := C.stelnet_asr_session_set_tts_noise_temp(s.handle, C.float(noiseTemp))
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_tts_noise_temp failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetExaggeration(exaggeration float32) error {
	rc := C.stelnet_asr_session_set_exaggeration(s.handle, C.float(exaggeration))
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_exaggeration failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetMaxSpeechTokens(n int) error {
	rc := C.stelnet_asr_session_set_max_speech_tokens(s.handle, C.int(n))
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_max_speech_tokens failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetMinSpeechTokens(n int) error {
	rc := C.stelnet_asr_session_set_min_speech_tokens(s.handle, C.int(n))
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_min_speech_tokens failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetLengthScale(scale float32) error {
	rc := C.stelnet_asr_session_set_length_scale(s.handle, C.float(scale))
	if rc != 0 && rc != -2 {
		return errors.New("stelnet_asr_session_set_length_scale failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetG2PDict(source string) error {
	cs := C.CString(source)
	defer C.free(unsafe.Pointer(cs))
	rc := C.stelnet_asr_session_set_g2p_dict(s.handle, cs)
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_g2p_dict failed")
	}
	return nil
}

// SetBestOf sets the best-of-N sampling count for ASR backends.
func (s *StelnetAsrSession) SetBestOf(n int) error {
	rc := C.stelnet_asr_session_set_best_of(s.handle, C.int(n))
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_best_of failed")
	}
	return nil
}

// SetBeamSize sets the beam-search width for ASR backends that support it.
func (s *StelnetAsrSession) SetBeamSize(n int) error {
	rc := C.stelnet_asr_session_set_beam_size(s.handle, C.int(n))
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_beam_size failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetReturnLogits(on bool) error {
	enable := C.int(0)
	if on {
		enable = 1
	}
	rc := C.stelnet_asr_session_set_return_logits(s.handle, enable)
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_return_logits failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetGrammarText(gbnfText, rootRule string, penalty float32) error {
	var cgbnf *C.char
	if gbnfText != "" {
	...
	rc := C.stelnet_asr_session_set_grammar_text(s.handle, cgbnf, croot, C.float(penalty))
	if rc == -2 {
		return errors.New("set_grammar_text: invalid GBNF or root rule not found")
	}
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_grammar_text failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetFallbackThresholds(entropyThold, logprobThold, noSpeechThold, temperatureInc float32) error {
	rc := C.stelnet_asr_session_set_fallback_thresholds(s.handle,
		C.float(entropyThold), C.float(logprobThold),
		C.float(noSpeechThold), C.float(temperatureInc))
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_fallback_thresholds failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetAltN(n int) error {
	rc := C.stelnet_asr_session_set_alt_n(s.handle, C.int(n))
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_alt_n failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetWhisperDecodeExtras(suppressNST bool, suppressRegex string, carryInitialPrompt bool) error {
	var cregex *C.char
	if suppressRegex != "" {
	...
	rc := C.stelnet_asr_session_set_whisper_decode_extras(s.handle, C.int(snst), cregex, C.int(carry))
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_whisper_decode_extras failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetAsk(prompt string) error {
	cprompt := C.CString(prompt)
	defer C.free(unsafe.Pointer(cprompt))
	rc := C.stelnet_asr_session_set_ask(s.handle, cprompt)
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_ask failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) StreamOpen(stepMs, lengthMs, keepMs int, language string, translate bool) (*Stream, error) {
	...
	h := C.stelnet_asr_session_stream_open(s.handle, C.int(4), C.int(stepMs), C.int(lengthMs), C.int(keepMs), clang, tr)
	if h == nil {
		return nil, errors.New("stelnet_asr_session_stream_open failed (whisper-only today)")
	}
...
func (st *Stream) Feed(pcm []float32) (int, error) {
	...
	rc := C.stelnet_asr_stream_feed(st.handle, (*C.float)(unsafe.Pointer(&pcm[0])), C.int(len(pcm)))
	if rc < 0 {
		return 0, errors.New("stelnet_asr_stream_feed failed")
	}
	return int(rc), nil
}
...
func (st *Stream) GetText() (StreamingUpdate, error) {
	...
	rc := C.stelnet_asr_stream_get_text(st.handle, &buf[0], C.int(len(buf)), &t0, &t1, &counter)
	if rc < 0 {
		return StreamingUpdate{}, errors.New("stelnet_asr_stream_get_text failed")
	}
...
func (st *Stream) Flush() error {
	if rc := C.stelnet_asr_stream_flush(st.handle); rc < 0 {
		return errors.New("stelnet_asr_stream_flush failed")
	}
	return nil
}
...
func (st *Stream) Close() {
	if st != nil && st.handle != nil {
		C.stelnet_asr_stream_close(st.handle)
		st.handle = nil
	}
}
...
func (s *StelnetAsrSession) DetectLanguage(pcm []float32, lidModelPath string, method int) (string, float32, error) {
	...
	rc := C.stelnet_asr_session_detect_language(s.handle, pcmPtr, C.int(len(pcm)), cpath, C.int(method),
		&outLang[0], C.int(len(outLang)), &outProb)
	if rc != 0 {
		return "", 0, errors.New("stelnet_asr_session_detect_language failed")
	}
...
func (s *StelnetAsrSession) SetCodecPath(path string) error {
	cpath := C.CString(path)
	defer C.free(unsafe.Pointer(cpath))
	rc := C.stelnet_asr_session_set_codec_path(s.handle, cpath)
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_codec_path failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetVoice(path, refText string) error {
	cpath := C.CString(path)
	defer C.free(unsafe.Pointer(cpath))
	var rtPtr *C.char
	if refText != "" {
	...
	rc := C.stelnet_asr_session_set_voice(s.handle, cpath, rtPtr)
	if rc != 0 {
		return errors.New("stelnet_asr_session_set_voice failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SetSpeakerName(name string) error {
	cname := C.CString(name)
	defer C.free(unsafe.Pointer(cname))
	rc := C.stelnet_asr_session_set_speaker_name(s.handle, cname)
	switch rc {
	case 0:
		return nil
	case -2:
	...
	default:
		return fmt.Errorf("stelnet_asr_session_set_speaker_name failed (rc=%d)", int(rc))
	}
}
...
func (s *StelnetAsrSession) SetSpeakerID(id int) error {
	rc := C.stelnet_asr_session_set_speaker_id(s.handle, C.int(id))
	switch rc {
	case 0:
		return nil
	case -2:
	...
	default:
		return fmt.Errorf("stelnet_asr_session_set_speaker_id failed (rc=%d)", int(rc))
	}
}
...
func (s *StelnetAsrSession) NSpeakers() int {
	return int(C.stelnet_asr_session_n_speakers(s.handle))
}
...
func (s *StelnetAsrSession) SetInstruct(instruct string) error {
	cins := C.CString(instruct)
	defer C.free(unsafe.Pointer(cins))
	rc := C.stelnet_asr_session_set_instruct(s.handle, cins)
	switch rc {
	case 0:
		return nil
	case -3:
	...
	default:
		return fmt.Errorf("stelnet_asr_session_set_instruct failed (rc=%d)", int(rc))
	}
}
...
func (s *StelnetAsrSession) SetTTSPhonemes(phonemes string) error {
	cps := C.CString(phonemes)
	defer C.free(unsafe.Pointer(cps))
	rc := C.stelnet_asr_session_set_tts_phonemes(s.handle, cps)
	switch rc {
	case 0:
		return nil
	case -2:
...
func (s *StelnetAsrSession) IsCustomVoice() bool {
	return C.stelnet_asr_session_is_custom_voice(s.handle) != 0
}

// IsVoiceDesign reports whether the loaded model is a qwen3-tts
// VoiceDesign variant (use SetInstruct for it).
func (s *StelnetAsrSession) IsVoiceDesign() bool {
	return C.stelnet_asr_session_is_voice_design(s.handle) != 0
}
...
func (s *StelnetAsrSession) Speakers() []string {
	n := int(C.stelnet_asr_session_n_speakers(s.handle))
	out := make([]string, 0, n)
	for i := 0; i < n; i++ {
		ptr := C.stelnet_asr_session_get_speaker_name(s.handle, C.int(i))
		if ptr != nil {
...
func (s *StelnetAsrSession) Synthesize(text string) ([]float32, error) {
	ctext := C.CString(text)
	defer C.free(unsafe.Pointer(ctext))
	var n C.int
	ptr := C.stelnet_asr_session_synthesize(s.handle, ctext, &n)
	if ptr == nil || n <= 0 {
		return nil, errors.New("stelnet_asr_session_synthesize: no audio produced")
	}
	defer C.stelnet_asr_pcm_free(ptr)
...
// it to "unknown".
func (s *StelnetAsrSession) SetSpeakerIdentity(identity string) error {
	if s == nil || s.handle == nil {
		return errors.New("session is closed")
	}
	cid := C.CString(identity)
	defer C.free(unsafe.Pointer(cid))
	switch rc := C.stelnet_asr_session_set_speaker_identity(s.handle, cid); rc {
	case 0:
		return nil
	case -2:
		return fmt.Errorf("unrecognised speaker_identity %q (expected real_person, synthetic or unknown)", identity)
	default:
		return fmt.Errorf("stelnet_asr_session_set_speaker_identity failed (rc=%d)", int(rc))
	}
}
...
func (s *StelnetAsrSession) AcceptMarkingResponsibility(attestation string) error {
	ca := C.CString(attestation)
	defer C.free(unsafe.Pointer(ca))
	if C.stelnet_asr_session_accept_marking_responsibility(s.handle, ca) != 0 {
		return errors.New("stelnet_asr_session_accept_marking_responsibility failed")
	}
	return nil
}
...
func (s *StelnetAsrSession) SynthesizeRaw(text string) ([]float32, error) {
	ctext := C.CString(text)
	defer C.free(unsafe.Pointer(ctext))
	var n C.int
	ptr := C.stelnet_asr_session_synthesize_raw(s.handle, ctext, &n)
	if ptr == nil || n <= 0 {
		return nil, errors.New("stelnet_asr_session_synthesize_raw: no audio (attestation required? call AcceptMarkingResponsibility first)")
	}
	defer C.stelnet_asr_pcm_free(ptr)
	samples := make([]float32, int(n))
	src := unsafe.Slice((*float32)(unsafe.Pointer(ptr)), int(n))
...
func (s *StelnetAsrSession) SpeechToSpeech(samples []float32) (*SpeechToSpeechResult, error) {
	if len(samples) == 0 {
		return nil, errors.New("SpeechToSpeech: empty input")
	}
	var textOut *C.char
	var nOut C.int
	ptr := C.stelnet_asr_session_speech_to_speech(
		s.handle,
		(*C.float)(unsafe.Pointer(&samples[0])),
		C.int(len(samples)),
		&textOut, &nOut)
	if ptr == nil || nOut <= 0 {
		return nil, errors.New("stelnet_asr_session_speech_to_speech: no audio produced " +
	...
	if textOut != nil {
		...
		C.stelnet_asr_session_translate_text_free(textOut)
	}
...
func (s *StelnetAsrSession) InputSampleRate() int {
	return int(C.stelnet_asr_session_input_sample_rate(s.handle))
}
...
func (s *StelnetAsrSession) OutputSampleRate() int {
	return int(C.stelnet_asr_session_output_sample_rate(s.handle))
}
...
func (s *StelnetAsrSession) Separate(pcmStereo []float32) ([]Stem, error) {
	if len(pcmStereo) < 2 {
	...
	nStems := C.stelnet_asr_session_separate(
		s.handle,
		(*C.float)(unsafe.Pointer(&pcmStereo[0])),
		C.int(nFrames))
	if nStems <= 0 {
		return nil, errors.New("stelnet_asr_session_separate: no stems produced (is this a separation model?)")
	}
	stems := make([]Stem, 0, int(nStems))
	for i := 0; i < int(nStems); i++ {
		name := C.GoString(C.stelnet_asr_session_separate_stem_name(s.handle, C.int(i)))
		if name == "" {
			name = fmt.Sprintf("stem%d", i)
		}
		var nOut C.int
		ptr := C.stelnet_asr_session_separate_stem(s.handle, C.int(i), &nOut)
		if ptr == nil || nOut <= 0 {
			return nil, fmt.Errorf("stelnet_asr_session_separate: stem %d (%s) came back empty", i, name)
		}
...
func (s *StelnetAsrSession) SeparateSampleRate() int {
	return int(C.stelnet_asr_session_separate_sample_rate(s.handle))
}
...
func (s *StelnetAsrSession) Transcribe(pcm []float32) (*TranscribeResult, error) {
...
func (s *StelnetAsrSession) TranscribeLang(pcm []float32, lang string) (*TranscribeResult, error) {
	if s.handle == nil {
	...
	r := C.stelnet_asr_session_transcribe_lang(s.handle, pcmPtr, C.int(len(pcm)), clang)
	if r == nil {
		return nil, errors.New("transcription failed")
	}
	defer C.stelnet_asr_session_result_free(r)
...
// is empty.
func (s *StelnetAsrSession) TranscribeWithLogits(pcm []float32) (*TranscribeResult, *CtcLogits, error) {
	if s.handle == nil {
	...
	pcmPtr := (*C.float)(unsafe.Pointer(&pcm[0]))
	r := C.stelnet_asr_session_transcribe(s.handle, pcmPtr, C.int(len(pcm)))
	if r == nil {
...
func (s *StelnetAsrSession) TranscribeChunked(pcm []float32, chunkSeconds, overlapSeconds int, lang string) (*TranscribeResult, error) {
	if s.handle == nil {
		return nil, errors.New("session is closed")
	}
	pcmPtr := (*C.float)(nil)
	...
	r := C.stelnet_asr_session_transcribe_chunked_lang(s.handle, pcmPtr, C.int(len(pcm)),
...
func GetProgress() int {
	return int(C.stelnet_asr_get_progress())
}

// TranscribeVAD transcribes with VAD segmentation.
// vadModelPath can be empty for auto-download of default Silero model.
func (s *StelnetAsrSession) TranscribeVAD(pcm []float32, sampleRate int, vadModelPath string) (*TranscribeResult, error) {
	if s.handle == nil {
		return nil, errors.New("session is closed")
	}
	pcmPtr := (*C.float)(nil)
	...
	r := C.stelnet_asr_session_transcribe_vad(s.handle, pcmPtr, C.int(len(pcm)), C.int(sampleRate), cvad, nil)
	if r == nil {
...
func extractResult(r *C.stelnet_asr_session_result) *TranscribeResult {
	nSegs := int(C.stelnet_asr_session_result_n_segments(r))
	result := &TranscribeResult{Segments: make([]TranscribeSegment, nSegs)}
	for i := 0; i < nSegs; i++ {
		seg := &result.Segments[i]
		seg.Text = C.GoString(C.stelnet_asr_session_result_segment_text(r, C.int(i)))
		seg.T0 = int64(C.stelnet_asr_session_result_segment_t0(r, C.int(i)))
		seg.T1 = int64(C.stelnet_asr_session_result_segment_t1(r, C.int(i)))
		seg.NoSpeechProb = float32(C.stelnet_asr_session_result_segment_no_speech_prob(r, C.int(i)))
		seg.Speaker = C.GoString(C.stelnet_asr_session_result_segment_speaker(r, C.int(i)))
		nWords := int(C.stelnet_asr_session_result_n_words(r, C.int(i)))
		seg.Words = make([]TranscribeWord, nWords)
		for j := 0; j < nWords; j++ {
			w := &seg.Words[j]
			w.Text = C.GoString(C.stelnet_asr_session_result_word_text(r, C.int(i), C.int(j)))
			w.T0 = int64(C.stelnet_asr_session_result_word_t0(r, C.int(i), C.int(j)))
			w.T1 = int64(C.stelnet_asr_session_result_word_t1(r, C.int(i), C.int(j)))
			w.P = float32(C.stelnet_asr_session_result_word_p(r, C.int(i), C.int(j)))
		}
	}
	return result
}
...
func extractLogits(r *C.stelnet_asr_session_result) *CtcLogits {
	nFrames := int(C.stelnet_asr_session_result_n_logit_frames(r))
	nVocab := int(C.stelnet_asr_session_result_n_logit_vocab(r))
	ptr := C.stelnet_asr_session_result_logits(r)
...
func (s *StelnetAsrSession) CtcVocab() []string {
	if s.handle == nil {
		return nil
	}
	n := int(C.stelnet_asr_session_n_vocab(s.handle))
	if n <= 0 {
		return nil
	}
	vocab := make([]string, n)
	for i := 0; i < n; i++ {
		vocab[i] = C.GoString(C.stelnet_asr_session_token_text(s.handle, C.int(i)))
	}
	return vocab
}
...
func AlignWords(alignerModel, transcript string, pcm []float32, tOffsetCs int64, nThreads int) ([]AlignedWord, error) {
	...
	r := C.stelnet_asr_align_words_abi(cm, ct, pcmPtr, C.int(len(pcm)), C.longlong(tOffsetCs), C.int(nThreads))
	if r == nil {
		return nil, errors.New("alignment failed")
	}
	defer C.stelnet_asr_align_result_free(r)
	n := int(C.stelnet_asr_align_result_n_words(r))
	words := make([]AlignedWord, n)
	for i := 0; i < n; i++ {
		words[i] = AlignedWord{
			Text: C.GoString(C.stelnet_asr_align_result_word_text(r, C.int(i))),
			T0:   int64(C.stelnet_asr_align_result_word_t0(r, C.int(i))),
			T1:   int64(C.stelnet_asr_align_result_word_t1(r, C.int(i))),
		}
	}
	return words, nil
}
...
func DetectLanguagePCM(pcm []float32, method int, modelPath string, nThreads int) (string, float32, error) {
	...
	var outLang [16]C.char
	var outProb C.float
	rc := C.stelnet_asr_detect_language_pcm(pcmPtr, C.int(len(pcm)), C.int(method), cm,
...
func VADSegments(vadModelPath string, pcm []float32, sampleRate int, threshold float32,
	...
	n := C.stelnet_asr_vad_segments(cm, pcmPtr, C.int(len(pcm)), C.int(sampleRate),
	...
	defer C.stelnet_asr_vad_free(outSpans)
...
func diarizeSegments(leftPCM, rightPCM []float32, isStereo bool, segs []DiarizeSeg,
	...
	cSegs := make([]C.struct_stelnet_asr_diarize_seg_abi, len(segs))
	for i, s := range segs {
	...
	opts := C.struct_stelnet_asr_diarize_opts_abi{
		method:              C.int(method),
	...
	rc := C.stelnet_asr_diarize_segments_abi(leftPtr, rightPtr, C.int(nSamples), stereo,
...
// StelnetASR default of ~/.cache/stelnet_asr/).
func NewSpeakerEmbedder(modelSpec string, nThreads int, cacheDir string) (*SpeakerEmbedder, error) {
	...
	h := C.stelnet_asr_speaker_embedder_make_abi(cSpec, C.int(nThreads), cCache)
	if h == nil {
...
func (e *SpeakerEmbedder) Dim() int {
	...
	return int(C.stelnet_asr_speaker_embedder_dim_abi(e.handle))
}
...
func (e *SpeakerEmbedder) Name() string {
	...
	cName := C.stelnet_asr_speaker_embedder_name_abi(e.handle)
	if cName == nil {
		return ""
	}
...
func (e *SpeakerEmbedder) Embed(pcm16k []float32) []float32 {
	...
	out := make([]float32, d)
	ok := C.stelnet_asr_speaker_embedder_embed_abi(
		e.handle,
...
func (e *SpeakerEmbedder) Close() {
	...
	C.stelnet_asr_speaker_embedder_free_abi(e.handle)
	e.handle = nil
}
...
func NewPyannoteCache(pcm16k []float32, modelPath string, nThreads int) (*PyannoteCache, error) {
	...
	cPath := C.CString(modelPath)
	defer C.free(unsafe.Pointer(cPath))
	h := C.stelnet_asr_pyannote_cache_compute_abi(
		(*C.float)(unsafe.Pointer(&pcm16k[0])),
...
func (c *PyannoteCache) Apply(segs []DiarizeSeg, sliceT0Cs int64) error {
	...
	rc := C.stelnet_asr_pyannote_cache_apply_abi(c.handle, C.longlong(sliceT0Cs),
		&cSegs[0], C.int(len(cSegs)))
	if rc != 0 {
		return fmt.Errorf("stelnet_asr_pyannote_cache_apply_abi rc=%d", int(rc))
	}
	for i := range segs {
		segs[i].Speaker = int32(cSegs[i].speaker)
	}
...
func (c *PyannoteCache) Close() {
	...
	C.stelnet_asr_pyannote_cache_free_abi(c.handle)
	c.handle = nil
}
...
func PuncInit(modelPath string) (*PuncModel, error) {
	cpath := C.CString(modelPath)
	defer C.free(unsafe.Pointer(cpath))
	h := C.stelnet_asr_punc_init(cpath)
	if h == nil {
		return nil, errors.New("stelnet_asr_punc_init failed for " + modelPath)
	}
...
func (p *PuncModel) Process(text string) (string, error) {
	ctext := C.CString(text)
	defer C.free(unsafe.Pointer(ctext))
	result := C.stelnet_asr_punc_process(p.handle, ctext)
	if result == nil {
		return text, errors.New("stelnet_asr_punc_process failed")
	}
	out := C.GoString(result)
	C.stelnet_asr_punc_free_text(result)
	return out, nil
}
...
func (p *PuncModel) Close() {
	if p != nil && p.handle != nil {
		C.stelnet_asr_punc_free(p.handle)
		p.handle = nil
	}
}
...
func RegistryLookup(backend string) (RegistryEntry, error) {
	...
	rc := C.stelnet_asr_registry_lookup_abi(cb, &fname[0], 512, &url[0], 512, &sz[0], 512)
	if rc != 0 {
...
func RegistryDefaultBundle(backend string) (RegistryBundle, error) {
	...
	count := C.stelnet_asr_registry_default_bundle_info_abi(
	...
	for index := C.int(0); index < count; index++ {
		...
		var url [2048]C.char
		var size [64]C.char
		rc := C.stelnet_asr_registry_default_bundle_artifact_abi(
			cb, index, &kind,
...
func CacheEnsureFile(filename, url, cacheDirOverride string) (string, error) {
	...
	var out [1024]C.char
	rc := C.stelnet_asr_cache_ensure_file_abi(cf, cu, 0, cdir, &out[0], 1024)
	if rc != 0 {
...
func CacheDir(override string) (string, error) {
	...
	var out [1024]C.char
	rc := C.stelnet_asr_cache_dir_abi(co, &out[0], 1024)
	if rc != 0 {
		return "", errors.New("stelnet_asr_cache_dir_abi failed")
	}
	return C.GoString(&out[0]), nil
}

// KokoroResolveForLang returns the kokoro model + fallback voice that
// StelnetASR's CLI would pick for `lang`. Mirrors PLAN #56 opt 2b. Wrappers
...
func KokoroResolveForLang(modelPath, lang string) (KokoroResolved, error) {
	...
	swapped := false
	rc := C.stelnet_asr_kokoro_resolve_model_for_lang_abi(cmodel, clang, outModel, 1024)
	if rc < 0 {
	...
	rc = C.stelnet_asr_kokoro_resolve_fallback_voice_abi(cmodel, clang, outVoice, 1024, outPicked, 64)
	if rc < 0 {
...
func SessionOpenExplicit(modelPath, backendName string, nThreads int) (*StelnetAsrSession, error) {
	cpath := C.CString(modelPath)
	defer C.free(unsafe.Pointer(cpath))
	cbe := C.CString(backendName)
	defer C.free(unsafe.Pointer(cbe))
	h := C.stelnet_asr_session_open_explicit(cpath, cbe, C.int(nThreads))
	if h == nil {
		return nil, fmt.Errorf("stelnet_asr_session_open_explicit: failed to open %s (backend=%s)", modelPath, backendName)
	}
	return &StelnetAsrSession{handle: h}, nil
}

// AvailableBackends returns the comma-separated list of backend names
// the loaded libstelnet_asr was built with.
func AvailableBackends() []string {
	var buf [1024]C.char
	C.stelnet_asr_session_available_backends(&buf[0], 1024)
...
func (s *StelnetAsrSession) DetectedLanguage() string {
	var buf [32]C.char
	C.stelnet_asr_session_detected_language(s.handle, &buf[0], 32)
...
func (s *StelnetAsrSession) TranslateText(text, srcLang, tgtLang string, maxTokens int) (string, error) {
	ct := C.CString(text)
	defer C.free(unsafe.Pointer(ct))
	...
	res := C.stelnet_asr_session_translate_text(s.handle, ct, cs, ctg, C.int(maxTokens))
	if res == nil {
		return "", nil
	}
	out := C.GoString(res)
	C.stelnet_asr_session_translate_text_free(res)
	return out, nil
}

// TranscribeVadLang transcribes with VAD segmentation and a language hint.
func (s *StelnetAsrSession) TranscribeVadLang(pcm []float32, sampleRate int,
	...
	clang := C.CString(language)
	defer C.free(unsafe.Pointer(clang))
	res := C.stelnet_asr_session_transcribe_vad_lang(s.handle,
		(*C.float)(unsafe.Pointer(&pcm[0])), C.int(len(pcm)),
		C.int(sampleRate), cvad, nil, clang)
	if res == nil {
		return nil, fmt.Errorf("stelnet_asr_session_transcribe_vad_lang failed")
	}
	defer C.stelnet_asr_session_result_free(res)
...
func DetectBackendFromGGUF(path string) (string, error) {
	...
	defer C.free(unsafe.Pointer(cpath))
	var out [128]C.char
	rc := C.stelnet_asr_detect_backend_from_gguf(cpath, &out[0], 128)
...
func EnhanceAudioRnnoise(pcm []float32) ([]float32, error) {
	...
	rc := C.stelnet_asr_enhance_audio_rnnoise(
		(*C.float)(unsafe.Pointer(&pcm[0])), C.int(len(pcm)),
...
func TextDetectLanguage(text, modelPath string, nThreads int) (string, float32, error) {
	...
	var label [64]C.char
	var conf C.float
	rc := C.stelnet_asr_text_detect_language(ct, cm, C.int(nThreads), &label[0], 64, &conf)
	if rc != 0 {
...
func RegistryLookupByFilename(filename string) (RegistryEntry, error) {
	...
	defer C.free(unsafe.Pointer(cf))
	var fname, url, sz [512]C.char
	rc := C.stelnet_asr_registry_lookup_by_filename_abi(cf, &fname[0], 512, &url[0], 512, &sz[0], 512)
	if rc != 0 {
...
func ListKnownModels() []string {
	var buf [8192]C.char
	n := C.stelnet_asr_registry_list_backends_abi(&buf[0], 8192)
	if n <= 0 {
		return nil
	}
...
func KokoroLangIsGerman(lang string) bool {
	cl := C.CString(lang)
	defer C.free(unsafe.Pointer(cl))
	return C.stelnet_asr_kokoro_lang_is_german_abi(cl) != 0
}
...
func KokoroLangHasNativeVoice(lang string) bool {
	cl := C.CString(lang)
	defer C.free(unsafe.Pointer(cl))
	return C.stelnet_asr_kokoro_lang_has_native_voice_abi(cl) != 0
}
...
func VadSlices(modelPath string, pcm []float32, sampleRate int,
	...
	if n < 0 {
		return nil, fmt.Errorf("stelnet_asr_vad_slices failed (rc=%d)", int(n))
	}
	...
	if n > 0 {
		...
		C.stelnet_asr_vad_free(outSpans)
	}
	return spans, nil
}
...
func LcsDedup(prevTail, curr []int32, minLcsLength int) int {
	...
	return int(C.stelnet_asr_lcs_dedup_prefix_count(
...
func ParakeetInit(modelPath string, nThreads int, useFlash bool) (*ParakeetContext, error) {
	...
	h := C.stelnet_asr_parakeet_init(cm, C.int(nThreads), flash)
	if h == nil {
		return nil, fmt.Errorf("stelnet_asr_parakeet_init failed for %s", modelPath)
	}
...
func (p *ParakeetContext) Transcribe(pcm []float32, language string) (*ParakeetResult, error) {
	...
	res := C.stelnet_asr_parakeet_transcribe(p.handle,
		(*C.float)(unsafe.Pointer(&pcm[0])), C.int(len(pcm)), clang)
	if res == nil {
		return nil, fmt.Errorf("stelnet_asr_parakeet_transcribe returned null")
	}
	defer C.stelnet_asr_parakeet_result_free(res)

	textPtr := C.stelnet_asr_parakeet_result_text(res)
	text := ""
	if textPtr != nil {
		text = C.GoString(textPtr)
	}

	nw := int(C.stelnet_asr_parakeet_result_n_words(res))
	words := make([]ParakeetWord, nw)
	for i := 0; i < nw; i++ {
		wp := C.stelnet_asr_parakeet_result_word_text(res, C.int(i))
		wt := ""
		if wp != nil {
			wt = C.GoString(wp)
		}
		words[i] = ParakeetWord{
			Text: wt,
			T0:   int64(C.stelnet_asr_parakeet_result_word_t0(res, C.int(i))),
			T1:   int64(C.stelnet_asr_parakeet_result_word_t1(res, C.int(i))),
		}
	}

	nt := int(C.stelnet_asr_parakeet_result_n_tokens(res))
	tokens := make([]ParakeetToken, nt)
	for i := 0; i < nt; i++ {
		tp := C.stelnet_asr_parakeet_result_token_text(res, C.int(i))
		tt := ""
		if tp != nil {
			tt = C.GoString(tp)
		}
		tokens[i] = ParakeetToken{
			Text: tt,
			T0:   int64(C.stelnet_asr_parakeet_result_token_t0(res, C.int(i))),
			T1:   int64(C.stelnet_asr_parakeet_result_token_t1(res, C.int(i))),
			P:    float32(C.stelnet_asr_parakeet_result_token_p(res, C.int(i))),
		}
	}
...
func (p *ParakeetContext) Close() {
	if p != nil && p.handle != nil {
		C.stelnet_asr_parakeet_free(p.handle)
		p.handle = nil
	}
}
...
func TitaNetInit(modelPath string, nThreads int) (*TitaNetContext, error) {
	cm := C.CString(modelPath)
	defer C.free(unsafe.Pointer(cm))
	h := C.stelnet_asr_titanet_init(cm, C.int(nThreads))
	if h == nil {
		return nil, fmt.Errorf("stelnet_asr_titanet_init failed for %s", modelPath)
	}
...
func (t *TitaNetContext) Embed(pcm16k []float32) ([]float32, error) {
	...
	dim := C.stelnet_asr_titanet_embed(t.handle,
...
func (t *TitaNetContext) Close() {
	if t != nil && t.handle != nil {
		C.stelnet_asr_titanet_free(t.handle)
		t.handle = nil
	}
}
...
func TitaNetCosineSim(a, b []float32) float32 {
	...
	return float32(C.stelnet_asr_titanet_cosine_sim(
...
func SpeakerDBOpen(dirPath, expectedNames string, consentAttested bool) (*SpeakerDB, error) {
	...
	h := C.stelnet_asr_speaker_db_open(cd, cn, 1)
	if h == nil {
		return nil, fmt.Errorf("stelnet_asr_speaker_db_open failed for %s", dirPath)
	}
...
func (db *SpeakerDB) Count() int {
	return int(C.stelnet_asr_speaker_db_count(db.handle))
}
...
func (db *SpeakerDB) Match(embedding []float32, threshold float32) (string, float32) {
	var name [256]C.char
	score := C.stelnet_asr_speaker_db_match(db.handle,
...
func (db *SpeakerDB) Enroll(name string, embedding []float32, consentAttested bool) error {
	...
	cn := C.CString(name)
	defer C.free(unsafe.Pointer(cn))
	rc := C.stelnet_asr_speaker_db_enroll2(cd, cn,
...
func (db *SpeakerDB) Close() {
	if db != nil && db.handle != nil {
		C.stelnet_asr_speaker_db_free(db.handle)
		db.handle = nil
	}
}
...
func WatermarkLoadModel(ggufPath string) error {
	...
	defer C.free(unsafe.Pointer(cp))
	rc := C.stelnet_asr_watermark_load_model(cp)
	if rc != 0 {
		return fmt.Errorf("stelnet_asr_watermark_load_model failed (rc=%d)", int(rc))
	}
	return nil
}
...
func WatermarkEmbed(pcm []float32) {
	...
	C.stelnet_asr_watermark_embed((*C.float)(unsafe.Pointer(&pcm[0])), C.int(len(pcm)), -1.0)
}
...
func WatermarkDetect(pcm []float32) float32 {
	...
	return float32(C.stelnet_asr_watermark_detect((*C.float)(unsafe.Pointer(&pcm[0])), C.int(len(pcm))))
}
